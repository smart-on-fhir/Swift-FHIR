...
//  SwiftFHIR
//
//  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/MedicationOrder) on 2015-11-24.
 ...
 *  department.
 */
public class MedicationOrderDispenseRequest: FHIRElement
{
	override public class var resourceName: String {
 ...
 */
public class MedicationOrderDosageInstruction: FHIRElement
{
	override public class var resourceName: String {
 ...
 */
public class MedicationOrderSubstitution: FHIRElement
{
	override public class var resourceName: String {
