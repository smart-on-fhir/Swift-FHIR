...
//  SMART-on-FHIR
//
//  Generated from FHIR 0.4.0.4394 (http://hl7.org/fhir/StructureDefinition/VisionClaim) on 2015-03-11.
...
public class VisionClaim: DomainResource
{
	...
	/// Goods and Services
	public var item: [VisionClaimItem]?
	...
	/// Payee
	public var payee: VisionClaimPayee?
	...
	public required init(json: JSONDictionary?) {
		...
		if let js = json {
			...
			if let val = js["item"] as? [JSONDictionary] {
				self.item = VisionClaimItem.from(val, owner: self) as? [VisionClaimItem]
			}
			...
			if let val = js["payee"] as? JSONDictionary {
				self.payee = VisionClaimPayee(json: val, owner: self)
			}
	...
	override public func asJSON() -> JSONDictionary {
		...
		if let coverage = self.coverage {
			json["coverage"] = VisionClaimCoverage.asJSONArray(coverage)
		}
		if let created = self.created {
			json["created"] = created.asJSON()
		}
		if let diagnosis = self.diagnosis {
			json["diagnosis"] = VisionClaimDiagnosis.asJSONArray(diagnosis)
		}
		...
		if let item = self.item {
			json["item"] = VisionClaimItem.asJSONArray(item)
		}
 ...
 */
public class VisionClaimCoverage: FHIRElement
{
	override public class var resourceName: String {
		get { return "VisionClaimCoverage" }
	}
 ...
 */
public class VisionClaimDiagnosis: FHIRElement
{
	override public class var resourceName: String {
		get { return "VisionClaimDiagnosis" }
	}
 ...
 */
public class VisionClaimItem: FHIRElement
{
	override public class var resourceName: String {
		get { return "VisionClaimItem" }
	}
	...
	/// Additional items
	public var detail: [VisionClaimItemDetail]?
	...
	public required init(json: JSONDictionary?) {
		...
		if let js = json {
			...
			if let val = js["detail"] as? [JSONDictionary] {
				self.detail = VisionClaimItemDetail.from(val, owner: self) as? [VisionClaimItemDetail]
			}
	...
	override public func asJSON() -> JSONDictionary {
		...
		if let detail = self.detail {
			json["detail"] = VisionClaimItemDetail.asJSONArray(detail)
		}
 ...
 */
public class VisionClaimItemDetail: FHIRElement
{
	override public class var resourceName: String {
		get { return "VisionClaimItemDetail" }
	}
	...
	/// Additional items
	public var subDetail: [VisionClaimItemDetailSubDetail]?
	...
	public required init(json: JSONDictionary?) {
		...
		if let js = json {
			...
			if let val = js["subDetail"] as? [JSONDictionary] {
				self.subDetail = VisionClaimItemDetailSubDetail.from(val, owner: self) as? [VisionClaimItemDetailSubDetail]
			}
			if let val = js["type"] as? JSONDictionary {
				self.type = Coding(json: val, owner: self)
			}
	...
	override public func asJSON() -> JSONDictionary {
		...
		if let subDetail = self.subDetail {
			json["subDetail"] = VisionClaimItemDetailSubDetail.asJSONArray(subDetail)
		}
		if let type = self.type {
			json["type"] = type.asJSON()
		}
 ...
 */
public class VisionClaimItemDetailSubDetail: FHIRElement
{
	override public class var resourceName: String {
		get { return "VisionClaimItemDetailSubDetail" }
	}
 ...
 */
public class VisionClaimPayee: FHIRElement
{
	override public class var resourceName: String {
		get { return "VisionClaimPayee" }
	}
