...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/CarePlan) on 2018-05-03.
...
open class CarePlanActivityDetail: BackboneElement {
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		goal = createInstances(of: Reference.self, for: "goal", in: json, context: &instCtx, owner: self) ?? goal
		instantiates = createInstance(type: FHIRURL.self, for: "instantiates", in: json, context: &instCtx, owner: self) ?? instantiates
	...
	override open func decorate(json: inout FHIRJSON, errors: inout [FHIRValidationError]) {
		...
		arrayDecorate(json: &json, withKey: "goal", using: self.goal, errors: &errors)
		self.instantiates?.decorate(json: &json, withKey: "instantiates", errors: &errors)
