...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/Consent) on 2018-05-03.
...
open class Consent: DomainResource {
	...
	public convenience init(category: [CodeableConcept], scope: CodeableConcept, status: EventStatus) {
		self.init()
