...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/DocumentManifest) on 2018-05-03.
...
open class DocumentManifest: DomainResource {
	...
	/// Agent involved.
	public var agent: [DocumentManifestAgent]?
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		agent = createInstances(of: DocumentManifestAgent.self, for: "agent", in: json, context: &instCtx, owner: self) ?? agent
...
*/
open class DocumentManifestAgent: BackboneElement {
	override open class var resourceType: String {
		get { return "DocumentManifestAgent" }
	}
