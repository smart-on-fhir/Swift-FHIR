...
//  SwiftFHIR
//
//  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/EventDefinition) on 2019-02-26.
...
open class EventDefinition: DomainResource {
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		if (nil == trigger || trigger!.isEmpty) && !instCtx.containsKey("trigger") {
	...
	override open func decorate(json: inout FHIRJSON, errors: inout [FHIRValidationError]) {
		...
		if nil == trigger || self.trigger!.isEmpty {
