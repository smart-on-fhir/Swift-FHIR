...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/ExampleScenario) on 2018-05-03.
...
open class ExampleScenarioProcessStep: BackboneElement {
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		alternative = createInstance(type: ExampleScenarioProcessStepAlternative.self, for: "alternative", in: json, context: &instCtx, owner: self) ?? alternative
	...
	override open func decorate(json: inout FHIRJSON, errors: inout [FHIRValidationError]) {
		...
		self.alternative?.decorate(json: &json, withKey: "alternative", errors: &errors)
...
open class ExampleScenarioProcessStepAlternative: BackboneElement {
	...
	public var option: [ExampleScenarioProcessStepAlternativeOption]?
	
	
	/** Convenience initializer, taking all required properties as arguments. */
	public convenience init(option: [ExampleScenarioProcessStepAlternativeOption]) {
		self.init()
		self.option = option
	}
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		name = createInstance(type: FHIRString.self, for: "name", in: json, context: &instCtx, owner: self) ?? name
		option = createInstances(of: ExampleScenarioProcessStepAlternativeOption.self, for: "option", in: json, context: &instCtx, owner: self) ?? option
		if (nil == option || option!.isEmpty) && !instCtx.containsKey("option") {
			instCtx.addError(FHIRValidationError(missing: "option"))
		}
	}
	...
	override open func decorate(json: inout FHIRJSON, errors: inout [FHIRValidationError]) {
		...
		if nil == option || self.option!.isEmpty {
			errors.append(FHIRValidationError(missing: "option"))
		}
	}
}
...
Each of the possible options in an alternative.
*/
open class ExampleScenarioProcessStepAlternativeOption: BackboneElement {
	override open class var resourceType: String {
		get { return "ExampleScenarioProcessStepAlternativeOption" }
	}
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		pause = createInstances(of: FHIRBool.self, for: "pause", in: json, context: &instCtx, owner: self) ?? pause
		step = createInstances(of: ExampleScenarioProcessStep.self, for: "step", in: json, context: &instCtx, owner: self) ?? step
	}
	...
	override open func decorate(json: inout FHIRJSON, errors: inout [FHIRValidationError]) {
		...
		arrayDecorate(json: &json, withKey: "pause", using: self.pause, errors: &errors)
		arrayDecorate(json: &json, withKey: "step", using: self.step, errors: &errors)
	}
}
