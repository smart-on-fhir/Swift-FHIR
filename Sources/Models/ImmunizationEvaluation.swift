...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/ImmunizationEvaluation) on 2018-05-03.
...
open class ImmunizationEvaluation: DomainResource {
	...
	public convenience init(doseStatus: CodeableConcept, immunizationEvent: Reference, patient: Reference, status: MedicationAdministrationStatus, targetDisease: [CodeableConcept]) {
		self.init()
