...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/ImplementationGuide) on 2018-05-03.
...
open class ImplementationGuideDefinition: BackboneElement {
	...
	public var package: [ImplementationGuideDefinitionPackage]?
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		package = createInstances(of: ImplementationGuideDefinitionPackage.self, for: "package", in: json, context: &instCtx, owner: self) ?? package
...
*/
open class ImplementationGuideDefinitionPackage: BackboneElement {
	override open class var resourceType: String {
		get { return "ImplementationGuideDefinitionPackage" }
	}
...
open class ImplementationGuideDefinitionPage: BackboneElement {
	...
	public convenience init(generation: GuidePageGeneration, name: Any, title: FHIRString) {
		...
		if let value = name as? FHIRURL {
			...
			fhir_warn("Type “\(type(of: name))” for property “\(name)” is invalid, ignoring")
		}
		self.title = title
	}
...
open class ImplementationGuideDefinitionResource: BackboneElement {
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		name = createInstance(type: FHIRString.self, for: "name", in: json, context: &instCtx, owner: self) ?? name
		package = createInstance(type: FHIRString.self, for: "package", in: json, context: &instCtx, owner: self) ?? package
