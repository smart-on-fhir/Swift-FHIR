...
//  SwiftFHIR
//
//  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/MedicationStatement) on 2019-03-01.
...
open class MedicationStatement: DomainResource {
	...
	public var status: MedicationStatementStatusCodes?
	...
	public convenience init(medication: Any, status: MedicationStatementStatusCodes, subject: Reference) {
		self.init()
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		status = createEnum(type: MedicationStatementStatusCodes.self, for: "status", in: json, context: &instCtx) ?? status
