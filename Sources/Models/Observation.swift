...
//  SwiftFHIR
//
//  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Observation) on 2015-12-11.
		...
		if let js = json {
			...
			if let exist: AnyObject = js["meaning"] {
				...
				if let val = exist as? FHIRJSON {
					...
					errors.append(FHIRJSONError(key: "meaning", wants: FHIRJSON.self, has: exist.dynamicType))
				}
			}
