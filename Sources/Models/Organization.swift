...
//  SwiftFHIR
//
//  Generated from FHIR 1.4.0.8139 (http://hl7.org/fhir/StructureDefinition/Organization) on 2016-04-05.
		...
		if let js = json {
			...
			if let exist: AnyObject = js["purpose"] {
				...
				if let val = exist as? FHIRJSON {
					...
					errors.append(FHIRJSONError(key: "purpose", wants: FHIRJSON.self, has: exist.dynamicType))
				}
			}
			if let exist: AnyObject = js["telecom"] {
				presentKeys.insert("telecom")
