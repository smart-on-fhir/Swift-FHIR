...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/Questionnaire) on 2018-05-03.
...
open class QuestionnaireItem: BackboneElement {
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		options = createInstance(type: FHIRURL.self, for: "options", in: json, context: &instCtx, owner: self) ?? options
...
open class QuestionnaireItemEnableWhen: BackboneElement {
	...
	public convenience init(answer: Any, operator_fhir: QuestionnaireItemOperator, question: FHIRString) {
		...
		if let value = answer as? FHIRBool {
			...
			fhir_warn("Type “\(type(of: answer))” for property “\(answer)” is invalid, ignoring")
		}
