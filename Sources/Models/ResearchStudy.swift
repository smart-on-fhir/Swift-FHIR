...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/ResearchStudy) on 2018-05-03.
...
open class ResearchStudy: DomainResource {
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		condition = createInstances(of: Reference.self, for: "condition", in: json, context: &instCtx, owner: self) ?? condition
