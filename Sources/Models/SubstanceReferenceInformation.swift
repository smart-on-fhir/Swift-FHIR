...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/SubstanceReferenceInformation) on 2018-05-03.
...
open class SubstanceReferenceInformation: DomainResource {
	...
	/// Todo.
	public var relationship: [SubstanceReferenceInformationRelationship]?
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		relationship = createInstances(of: SubstanceReferenceInformationRelationship.self, for: "relationship", in: json, context: &instCtx, owner: self) ?? relationship
...
Todo.
*/
open class SubstanceReferenceInformationRelationship: BackboneElement {
	override open class var resourceType: String {
		get { return "SubstanceReferenceInformationRelationship" }
	}
