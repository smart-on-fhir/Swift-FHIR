...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/Task) on 2018-05-03.
...
open class Task: DomainResource {
	...
	public var instantiatesReference: Reference?
	...
	override open func populate(from json: FHIRJSON, context instCtx: inout FHIRInstantiationContext) {
		...
		instantiatesReference = createInstance(type: Reference.self, for: "instantiatesReference", in: json, context: &instCtx, owner: self) ?? instantiatesReference
	...
	override open func decorate(json: inout FHIRJSON, errors: inout [FHIRValidationError]) {
		...
		self.instantiatesReference?.decorate(json: &json, withKey: "instantiatesReference", errors: &errors)
