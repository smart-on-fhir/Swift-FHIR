...
//  SwiftFHIR
//
//  Generated from FHIR 3.3.0.13671 (http://hl7.org/fhir/StructureDefinition/TerminologyCapabilities) on 2018-05-03.
...
A Terminology Capabilities documents a set of capabilities (behaviors) of a FHIR Server that may be used as a statement
...
open class TerminologyCapabilities: DomainResource {
	...
	public convenience init(date: DateTime, status: PublicationStatus) {
		self.init()
		self.date = date
		self.status = status
	}
