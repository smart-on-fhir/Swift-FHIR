...
class CarePlanTests: FHIRModelTestCase
{
	...
	func runCarePlan9(json: FHIRJSON? = nil) throws -> CarePlan {
		...
		XCTAssertFalse(inst.activity![0].detail!.prohibited!)
		XCTAssertEqual(inst.activity![0].detail!.scheduledTiming!.repeat_fhir!.bounds!.end!.description, "2013-02-28")
		XCTAssertEqual(inst.activity![0].detail!.scheduledTiming!.repeat_fhir!.bounds!.start!.description, "2013-02-14")
		...
		XCTAssertFalse(inst.activity![1].detail!.prohibited!)
		XCTAssertEqual(inst.activity![1].detail!.scheduledTiming!.repeat_fhir!.bounds!.end!.description, "2013-03-14")
		XCTAssertEqual(inst.activity![1].detail!.scheduledTiming!.repeat_fhir!.bounds!.start!.description, "2013-03-01")
		XCTAssertEqual(inst.activity![1].detail!.status!, "not-started")
		...
		XCTAssertFalse(inst.activity![2].detail!.prohibited!)
		XCTAssertEqual(inst.activity![2].detail!.scheduledTiming!.repeat_fhir!.bounds!.end!.description, "2013-09-14")
		XCTAssertEqual(inst.activity![2].detail!.scheduledTiming!.repeat_fhir!.bounds!.start!.description, "2013-09-01")
