...
class ClaimResponseTests: FHIRModelTestCase
{
	...
	func testClaimResponse1_impl(json: JSONDictionary? = nil) -> ClaimResponse {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "claimresponse-example.canonical.json")
	...
	func testClaimResponse2() {
		let instance = testClaimResponse2_impl()
		testClaimResponse2_impl(json: instance.asJSON())
	}
	
	func testClaimResponse2_impl(json: JSONDictionary? = nil) -> ClaimResponse {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "claimresponse-example.canonical.json")
	...
	func testClaimResponse3() {
		let instance = testClaimResponse3_impl()
		testClaimResponse3_impl(json: instance.asJSON())
	}
	
	func testClaimResponse3_impl(json: JSONDictionary? = nil) -> ClaimResponse {
