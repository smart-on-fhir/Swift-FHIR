...
class CommunicationTests: FHIRModelTestCase
{
	...
	func testCommunication1_impl(json: JSONDictionary? = nil) -> Communication {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "communication-example.canonical.json")
	...
	func testCommunication3() {
		let instance = testCommunication3_impl()
		testCommunication3_impl(json: instance.asJSON())
	}
	
	func testCommunication3_impl(json: JSONDictionary? = nil) -> Communication {
