...
class CommunicationTests: FHIRModelTestCase
{
	...
	func testCommunication1() {
		...
		XCTAssertEqual(inst!.category!.coding![0].system!, NSURL(string: "http://acme.org/messagetypes")!)
		...
		XCTAssertEqual(inst!.sent!, NSDate.dateFromISOString("2014-12-12T18:01:10-08:00")!)
