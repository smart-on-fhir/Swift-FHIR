...
class ConceptMapTests: FHIRModelTestCase
{
	...
	func instantiateFrom(json json: FHIRJSON) -> ConceptMap {
	...
	func testConceptMap1_impl(json: FHIRJSON? = nil) throws -> ConceptMap {
		...
		XCTAssertEqual(inst.element![1].map![0].product![0].code!, "47002008")
		XCTAssertEqual(inst.element![1].map![0].product![0].codeSystem!.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.element![1].map![0].product![0].element!.absoluteString, "http://hl7.org/fhir/v2/element/SPM-5")
		...
		XCTAssertEqual(inst.element![3].map![0].product![0].code!, "7970006")
		XCTAssertEqual(inst.element![3].map![0].product![0].codeSystem!.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.element![3].map![0].product![0].element!.absoluteString, "http://hl7.org/fhir/v2/element/SPM-5")
		...
		XCTAssertEqual(inst.element![4].map![0].product![0].code!, "81723002")
		XCTAssertEqual(inst.element![4].map![0].product![0].codeSystem!.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.element![4].map![0].product![0].element!.absoluteString, "http://hl7.org/fhir/v2/element/SPM-7")
		...
		XCTAssertEqual(inst.element![8].map![0].product![0].code!, "14766002")
		XCTAssertEqual(inst.element![8].map![0].product![0].codeSystem!.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.element![8].map![0].product![0].element!.absoluteString, "http://hl7.org/fhir/v2/element/SPM-7")
