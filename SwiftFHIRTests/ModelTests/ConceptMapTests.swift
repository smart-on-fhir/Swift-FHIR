...
class ConceptMapTests: FHIRModelTestCase
{
	...
	func testConceptMap3() {
		let instance = testConceptMap3_impl()
		testConceptMap3_impl(json: instance.asJSON())
	}
	...
	func testConceptMap4() {
		let instance = testConceptMap4_impl()
		testConceptMap4_impl(json: instance.asJSON())
	}
	...
	func testConceptMap5() {
		let instance = testConceptMap5_impl()
		testConceptMap5_impl(json: instance.asJSON())
	}
