...
class ConditionTests: FHIRModelTestCase
{
	...
	func testCondition4() {
		...
		XCTAssertEqual(inst!.relatedItem![0].target!.display!, "TPF chemokuur")	
		XCTAssertEqual(inst!.relatedItem![0].target!.reference!, "Procedure/f201")	
		XCTAssertEqual(inst!.relatedItem![0].type!, "due-to")	
		XCTAssertEqual(inst!.relatedItem![1].target!.display!, "bacterial infection")	
		XCTAssertEqual(inst!.relatedItem![1].target!.reference!, "Condition/f205")	
	...
	func testCondition6() {
		...
		XCTAssertEqual(inst!.relatedItem![0].target!.display!, "Staphylococcus Aureus")	
		XCTAssertEqual(inst!.relatedItem![0].target!.reference!, "Substance/f202")	
		XCTAssertEqual(inst!.relatedItem![0].type!, "due-to")	
	...
	func testCondition7() {
		...
		XCTAssertEqual(inst!.relatedItem![0].target!.display!, "TPF chemotherapy for the sphenoid bone")	
		XCTAssertEqual(inst!.relatedItem![0].target!.reference!, "Procedure/f201")	
		XCTAssertEqual(inst!.relatedItem![0].type!, "due-to")	
		XCTAssertEqual(inst!.severity!.coding![0].code!, "24484000")	
		XCTAssertEqual(inst!.severity!.coding![0].display!, "Severe")
