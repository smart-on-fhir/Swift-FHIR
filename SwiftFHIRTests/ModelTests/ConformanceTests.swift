...
class ConformanceTests: XCTestCase
{
	...
	func runConformance1(json: FHIRJSON? = nil) throws -> Conformance {
		...
		XCTAssertTrue(inst.rest![0].resource![0].conditionalCreate!)
		XCTAssertEqual(inst.rest![0].resource![0].conditionalDelete!, "not-supported")
		XCTAssertFalse(inst.rest![0].resource![0].conditionalUpdate!)
		...
		XCTAssertTrue(inst.rest![0].resource![0].readHistory!)
		...
		XCTAssertFalse(inst.rest![0].resource![0].updateCreate!)
		...
		XCTAssertTrue(inst.rest![0].security!.cors!)
