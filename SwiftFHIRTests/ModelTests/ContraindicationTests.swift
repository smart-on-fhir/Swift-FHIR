...
class ContraindicationTests: FHIRModelTestCase
{
	...
	func testContraindication4() {
		...
		XCTAssertEqual(inst!.category!.coding![0].system!, NSURL(string: "http://hl7.org/fhir/v3/ActCode")!)
		XCTAssertEqual(inst!.date!, NSDate.dateFromISOString("2013-05-08")!)
	...
	func testContraindication8() {
		...
		XCTAssertEqual(inst!.category!.coding![0].system!, NSURL(string: "http://hl7.org/fhir/v3/ActCode")!)
		XCTAssertEqual(inst!.date!, NSDate.dateFromISOString("2014-01-05")!)
		...
		XCTAssertEqual(inst!.mitigation![0].action!.coding![0].system!, NSURL(string: "http://hl7.org/fhir/v3/ActCode")!)
		...
		XCTAssertEqual(inst!.mitigation![0].date!, NSDate.dateFromISOString("2014-01-05")!)
