...
class DeviceMetricTests: FHIRModelTestCase
{
	...
	func testDeviceMetric1() {
		...
		XCTAssertEqual(inst!.identifier!.system!, NSURL(string: "http://goodcare.org/devicemetric/id")!)
		...
		XCTAssertEqual(inst!.type!.coding![0].system!, NSURL(string: "https://rtmms.nist.gov")!)
		XCTAssertEqual(inst!.unit!.coding![0].code!, "262688")
		XCTAssertEqual(inst!.unit!.coding![0].display!, "MDC_DIM_PERCENT")
		XCTAssertEqual(inst!.unit!.coding![0].system!, NSURL(string: "https://rtmms.nist.gov")!)
	}
