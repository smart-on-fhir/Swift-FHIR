...
class DocumentManifestTests: FHIRModelTestCase
{
	...
	func testDocumentManifest1_impl(json: JSONDictionary? = nil) -> DocumentManifest {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "documentmanifest-example.canonical.json")
	...
	func testDocumentManifest2() {
		let instance = testDocumentManifest2_impl()
		testDocumentManifest2_impl(json: instance.asJSON())
	}
	
	func testDocumentManifest2_impl(json: JSONDictionary? = nil) -> DocumentManifest {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "documentmanifest-example.canonical.json")
	...
	func testDocumentManifest3() {
		let instance = testDocumentManifest3_impl()
		testDocumentManifest3_impl(json: instance.asJSON())
	}
	
	func testDocumentManifest3_impl(json: JSONDictionary? = nil) -> DocumentManifest {
