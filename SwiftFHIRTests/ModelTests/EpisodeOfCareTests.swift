...
class EpisodeOfCareTests: FHIRModelTestCase
{
	...
	func testEpisodeOfCare1() {
		...
		XCTAssertEqual(inst!.careTeam![0].period!.end!, NSDate.dateFromISOString("2014-09-16")!)
		XCTAssertEqual(inst!.careTeam![0].period!.start!, NSDate.dateFromISOString("2014-09-01")!)
		...
		XCTAssertEqual(inst!.careTeam![0].role![0].coding![0].system!, NSURL(string: "http://example.org/EpisodeOfCare/Role")!)
		XCTAssertEqual(inst!.currentStatus!, "active")
		XCTAssertEqual(inst!.managingOrganization!.reference!, "Organization/hl7")
		XCTAssertEqual(inst!.patient!.reference!, "Patient/example")
		XCTAssertEqual(inst!.period!.start!, NSDate.dateFromISOString("2014-09-01")!)
		XCTAssertEqual(inst!.statusHistory![0].period!.end!, NSDate.dateFromISOString("2014-09-14")!)
		XCTAssertEqual(inst!.statusHistory![0].period!.start!, NSDate.dateFromISOString("2014-09-01")!)
		XCTAssertEqual(inst!.statusHistory![0].status!, "planned")
		XCTAssertEqual(inst!.statusHistory![1].period!.end!, NSDate.dateFromISOString("2014-09-21")!)
		XCTAssertEqual(inst!.statusHistory![1].period!.start!, NSDate.dateFromISOString("2014-09-15")!)
		XCTAssertEqual(inst!.statusHistory![1].status!, "active")
		XCTAssertEqual(inst!.statusHistory![2].period!.end!, NSDate.dateFromISOString("2014-09-24")!)
		XCTAssertEqual(inst!.statusHistory![2].period!.start!, NSDate.dateFromISOString("2014-09-22")!)
		XCTAssertEqual(inst!.statusHistory![2].status!, "onhold")
		XCTAssertEqual(inst!.statusHistory![3].period!.start!, NSDate.dateFromISOString("2014-09-25")!)
		...
		XCTAssertEqual(inst!.type![0].coding![0].system!, NSURL(string: "http://example.org/EpisodeOfCare/Type")!)
	}
