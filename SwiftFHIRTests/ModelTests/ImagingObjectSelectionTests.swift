...
class ImagingObjectSelectionTests: FHIRModelTestCase
{
	...
	func testImagingObjectSelection2() {
		let instance = testImagingObjectSelection2_impl()
		testImagingObjectSelection2_impl(json: instance.asJSON())
	}
	
	func testImagingObjectSelection2_impl(json: JSONDictionary? = nil) -> ImagingObjectSelection {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "imagingobjectselection-example.canonical.json")
	...
	func testImagingObjectSelection3() {
		let instance = testImagingObjectSelection3_impl()
		testImagingObjectSelection3_impl(json: instance.asJSON())
	}
	
	func testImagingObjectSelection3_impl(json: JSONDictionary? = nil) -> ImagingObjectSelection {
