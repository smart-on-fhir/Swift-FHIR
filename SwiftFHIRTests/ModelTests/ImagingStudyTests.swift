...
class ImagingStudyTests: FHIRModelTestCase
{
	...
	func testImagingStudy1() {
		...
		XCTAssertEqual(inst!.series![0].bodySite!.system!, NSURL(string: "http://snomed.info/sct")!)
		...
		XCTAssertEqual(inst!.started!, NSDate.dateFromISOString("2011-01-01T11:01:20")!)
