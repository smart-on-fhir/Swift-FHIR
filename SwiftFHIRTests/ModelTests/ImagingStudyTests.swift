...
class ImagingStudyTests: FHIRModelTestCase
{
	...
	func testImagingStudy4() {
		let instance = testImagingStudy4_impl()
		testImagingStudy4_impl(json: instance.asJSON())
	}
	
	func testImagingStudy4_impl(json: JSONDictionary? = nil) -> ImagingStudy {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "imagingstudy-qicore-example.canonical.json")
	...
	func testImagingStudy5() {
		let instance = testImagingStudy5_impl()
		testImagingStudy5_impl(json: instance.asJSON())
	}
	
	func testImagingStudy5_impl(json: JSONDictionary? = nil) -> ImagingStudy {
