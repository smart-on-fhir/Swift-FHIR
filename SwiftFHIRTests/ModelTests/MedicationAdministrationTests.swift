...
class MedicationAdministrationTests: FHIRModelTestCase
{
	...
	func testMedicationAdministration1_impl(json: JSONDictionary? = nil) -> MedicationAdministration {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "medicationadministration-example.canonical.json")
	...
	func testMedicationAdministration3() {
		let instance = testMedicationAdministration3_impl()
		testMedicationAdministration3_impl(json: instance.asJSON())
	}
	
	func testMedicationAdministration3_impl(json: JSONDictionary? = nil) -> MedicationAdministration {
	...
	func testMedicationAdministration4() {
		let instance = testMedicationAdministration4_impl()
		testMedicationAdministration4_impl(json: instance.asJSON())
	}
	
	func testMedicationAdministration4_impl(json: JSONDictionary? = nil) -> MedicationAdministration {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "medicationadministration-qicore-example.canonical.json")
	...
	func testMedicationAdministration5() {
		let instance = testMedicationAdministration5_impl()
		testMedicationAdministration5_impl(json: instance.asJSON())
	}
	
	func testMedicationAdministration5_impl(json: JSONDictionary? = nil) -> MedicationAdministration {
