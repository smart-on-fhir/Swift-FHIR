...
class MedicationDispenseTests: FHIRModelTestCase
{
	...
	func testMedicationDispense4() {
		let instance = testMedicationDispense4_impl()
		testMedicationDispense4_impl(json: instance.asJSON())
	}
	
	func testMedicationDispense4_impl(json: JSONDictionary? = nil) -> MedicationDispense {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "medicationdispense-qicore-example.canonical.json")
	...
	func testMedicationDispense5() {
		let instance = testMedicationDispense5_impl()
		testMedicationDispense5_impl(json: instance.asJSON())
	}
	
	func testMedicationDispense5_impl(json: JSONDictionary? = nil) -> MedicationDispense {
