...
{
	func instantiateFrom(filename filename: String) throws -> MedicationPrescription {
		return instantiateFrom(json: try readJSONFile(filename)!)
	}
	
	func instantiateFrom(json json: FHIRJSON) -> MedicationPrescription {
	...
	func testMedicationPrescription1_impl(json: FHIRJSON? = nil) throws -> MedicationPrescription {
		...
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.bounds!.end!.description, "2013-11-05")
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.bounds!.start!.description, "2013-08-04")
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.frequency!, 3)
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.period!, NSDecimalNumber(string: "1"))
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.periodUnits!, "d")
	...
	func testMedicationPrescription2_impl(json: FHIRJSON? = nil) throws -> MedicationPrescription {
		...
		XCTAssertEqual(inst.dosageInstruction![0].route!.coding![0].system!.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.bounds!.start!.description, "2013-08-04")
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.frequency!, 1)
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.period!, NSDecimalNumber(string: "1"))
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.periodUnits!, "d")
		XCTAssertEqual(inst.dosageInstruction![0].site!.coding![0].code!, "181220002")
		XCTAssertEqual(inst.dosageInstruction![0].site!.coding![0].display!, "Entire oral cavity")
	...
	func testMedicationPrescription3_impl(json: FHIRJSON? = nil) throws -> MedicationPrescription {
		...
		XCTAssertEqual(inst.dosageInstruction![0].route!.coding![0].display!, "Administration of drug or medicament via oral route")
		XCTAssertEqual(inst.dosageInstruction![0].route!.coding![0].system!.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.bounds!.start!.description, "2011-05-01")
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.frequency!, 3)
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.period!, NSDecimalNumber(string: "1"))
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.periodUnits!, "d")
		XCTAssertEqual(inst.dosageInstruction![0].site!.coding![0].code!, "181220002")
	...
	func testMedicationPrescription6_impl(json: FHIRJSON? = nil) throws -> MedicationPrescription {
		...
		XCTAssertEqual(inst.dosageInstruction![0].route!.coding![0].system!.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.bounds!.end!.description, "2013-05-11")
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.bounds!.start!.description, "2013-03-11")
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.frequency!, 2)
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.period!, NSDecimalNumber(string: "1"))
		XCTAssertEqual(inst.dosageInstruction![0].scheduledTiming!.repeat_fhir!.periodUnits!, "d")
