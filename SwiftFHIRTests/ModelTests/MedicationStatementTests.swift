...
class MedicationStatementTests: FHIRModelTestCase
{
	...
	func testMedicationStatement1() {
		...
		XCTAssertEqual(inst!.whenGiven!.start!.description, "2010")
	}
	...
	func testMedicationStatement4() {
		...
		XCTAssertEqual(inst!.patient!.reference!, "Patient/example")
		XCTAssertEqual(inst!.whenGiven!.end!.description, "2012-06-01T14:30:00+14:00")
		XCTAssertEqual(inst!.whenGiven!.start!.description, "2012-06-01T14:30:00+14:00")
	}
