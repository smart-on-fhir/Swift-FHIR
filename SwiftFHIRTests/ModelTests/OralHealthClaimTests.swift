...
class OralHealthClaimTests: FHIRModelTestCase
{
	...
	func testOralHealthClaim6_impl(json: JSONDictionary? = nil) -> OralHealthClaim {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "oralhealthclaim-example-orthoplan.canonical.json")
	...
	func testOralHealthClaim8() {
		let instance = testOralHealthClaim8_impl()
		testOralHealthClaim8_impl(json: instance.asJSON())
	}
	
	func testOralHealthClaim8_impl(json: JSONDictionary? = nil) -> OralHealthClaim {
	...
	func testOralHealthClaim9() {
		let instance = testOralHealthClaim9_impl()
		testOralHealthClaim9_impl(json: instance.asJSON())
	}
	
	func testOralHealthClaim9_impl(json: JSONDictionary? = nil) -> OralHealthClaim {
