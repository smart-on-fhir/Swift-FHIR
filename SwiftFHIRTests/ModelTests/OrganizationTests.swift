...
class OrganizationTests: FHIRModelTestCase
{
	...
	func testOrganization6_impl(json: JSONDictionary? = nil) -> Organization {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "organization-example-f003-burgers-ENT.canonical.json")
	...
	func testOrganization8_impl(json: JSONDictionary? = nil) -> Organization {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "organization-example-f201-aumc.canonical.json")
	...
	func testOrganization10_impl(json: JSONDictionary? = nil) -> Organization {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "organization-example-f203-bumc.canonical.json")
