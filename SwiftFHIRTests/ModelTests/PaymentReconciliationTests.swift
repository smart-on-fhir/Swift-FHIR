...
class PaymentReconciliationTests: FHIRModelTestCase
{
	...
	func testPaymentReconciliation1_impl(json: JSONDictionary? = nil) -> PaymentReconciliation {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "paymentreconciliation-example.canonical.json")
		...
		XCTAssertEqual(inst.detail![0].type!.system!.absoluteString!, "http://www.hl7.org/fhir/paymenttype")
		...
		XCTAssertEqual(inst.detail![1].type!.system!.absoluteString!, "http://www.hl7.org/fhir/paymenttype")
	...
	func testPaymentReconciliation2() {
		let instance = testPaymentReconciliation2_impl()
		testPaymentReconciliation2_impl(json: instance.asJSON())
	}
	
	func testPaymentReconciliation2_impl(json: JSONDictionary? = nil) -> PaymentReconciliation {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "paymentreconciliation-example.canonical.json")
	...
	func testPaymentReconciliation3() {
		let instance = testPaymentReconciliation3_impl()
		testPaymentReconciliation3_impl(json: instance.asJSON())
	}
	
	func testPaymentReconciliation3_impl(json: JSONDictionary? = nil) -> PaymentReconciliation {
