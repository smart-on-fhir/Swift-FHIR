...
class ProcedureTests: FHIRModelTestCase
{
	...
	func testProcedure1_impl(json: JSONDictionary? = nil) -> Procedure {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "procedure-example-biopsy.canonical.json")
	...
	func testProcedure4_impl(json: JSONDictionary? = nil) -> Procedure {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "procedure-example-f001-heart.canonical.json")
	...
	func testProcedure6_impl(json: JSONDictionary? = nil) -> Procedure {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "procedure-example-f002-lung.canonical.json")
	...
	func testProcedure8_impl(json: JSONDictionary? = nil) -> Procedure {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "procedure-example-f003-abscess.canonical.json")
	...
	func testProcedure9_impl(json: JSONDictionary? = nil) -> Procedure {
	...
	func testProcedure10() {
		let instance = testProcedure10_impl()
		testProcedure10_impl(json: instance.asJSON())
	}
	
	func testProcedure10_impl(json: JSONDictionary? = nil) -> Procedure {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "procedure-example-f004-tracheotomy.canonical.json")
