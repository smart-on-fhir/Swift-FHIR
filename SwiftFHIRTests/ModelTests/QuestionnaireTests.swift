...
class QuestionnaireTests: FHIRModelTestCase
{
	...
	func testQuestionnaire8() {
		let instance = testQuestionnaire8_impl()
		testQuestionnaire8_impl(json: instance.asJSON())
	}
	
	func testQuestionnaire8_impl(json: JSONDictionary? = nil) -> Questionnaire {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "questionnaire-sdc-profile-example-LOINC.canonical.json")
	...
	func testQuestionnaire9() {
		let instance = testQuestionnaire9_impl()
		testQuestionnaire9_impl(json: instance.asJSON())
	}
	
	func testQuestionnaire9_impl(json: JSONDictionary? = nil) -> Questionnaire {
