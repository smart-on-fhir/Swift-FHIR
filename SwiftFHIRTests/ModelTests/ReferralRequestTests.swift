...
class ReferralRequestTests: FHIRModelTestCase
{
	...
	func testReferralRequest1() {
		...
		XCTAssertEqual(inst!.dateSent!, NSDate.dateFromISOString("2014-02-14")!)
		...
		XCTAssertEqual(inst!.identifier![0].system!, NSURL(string: "http://orionhealth.com/fhir/apps/referralids")!)
		...
		XCTAssertEqual(inst!.priority!.coding![0].system!, NSURL(string: "http://orionhealth.com/fhir/apps/prioritycodes")!)
		...
		XCTAssertEqual(inst!.serviceRequested![0].coding![0].system!, NSURL(string: "http://snomed.info/sct")!)
		...
		XCTAssertEqual(inst!.specialty!.coding![0].system!, NSURL(string: "http://orionhealth.com/fhir/apps/specialties")!)
		...
		XCTAssertEqual(inst!.type!.coding![0].system!, NSURL(string: "http://orionhealth.com/fhir/apps/referraltypes")!)
	}
