...
class RiskAssessmentTests: FHIRModelTestCase
{
	...
	func testRiskAssessment1() {
		...
		XCTAssertEqual(inst!.date!, NSDate.dateFromISOString("2014-07-19T16:04:00")!)
		...
		XCTAssertEqual(inst!.prediction![0].whenRange!.high!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![0].whenRange!.low!.system!, NSURL(string: "http://unitsofmeasure.org")!)
	...
	func testRiskAssessment6() {
		...
		XCTAssertEqual(inst!.date!, NSDate.dateFromISOString("2010-11-22")!)
		XCTAssertEqual(inst!.prediction![0].outcome!.coding![0].code!, "249943000:363698007=72098002,260868000=6934004")
		XCTAssertEqual(inst!.prediction![0].outcome!.coding![0].system!, NSURL(string: "http://snomed.info/sct")!)
		...
		XCTAssertEqual(inst!.prediction![0].probabilityCodeableConcept!.coding![0].system!, NSURL(string: "http://hl7.org/fhir/risk-probability")!)
	}
	...
	func testRiskAssessment8() {
		...
		XCTAssertEqual(inst!.date!, NSDate.dateFromISOString("2006-01-13T23:01:00")!)
		...
		XCTAssertEqual(inst!.prediction![1].whenRange!.high!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![1].whenRange!.low!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![2].whenRange!.high!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![2].whenRange!.low!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![3].whenRange!.high!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![3].whenRange!.low!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![4].whenRange!.high!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![4].whenRange!.low!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![5].whenRange!.high!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![5].whenRange!.low!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![6].whenRange!.high!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![6].whenRange!.low!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![7].whenRange!.high!.system!, NSURL(string: "http://unitsofmeasure.org")!)
		...
		XCTAssertEqual(inst!.prediction![7].whenRange!.low!.system!, NSURL(string: "http://unitsofmeasure.org")!)
