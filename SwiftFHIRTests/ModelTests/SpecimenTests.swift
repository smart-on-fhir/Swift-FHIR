...
class SpecimenTests: FHIRModelTestCase
{
	...
	func testSpecimen1_impl(json: JSONDictionary? = nil) -> Specimen {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "spec-uslab-example1.canonical.json")
	...
	func testSpecimen4_impl(json: JSONDictionary? = nil) -> Specimen {
	...
	func testSpecimen5() {
		let instance = testSpecimen5_impl()
		testSpecimen5_impl(json: instance.asJSON())
	}
	
	func testSpecimen5_impl(json: JSONDictionary? = nil) -> Specimen {
