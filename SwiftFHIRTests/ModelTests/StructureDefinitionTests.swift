...
class StructureDefinitionTests: FHIRModelTestCase
{
	...
	func testStructureDefinition1_impl(json: JSONDictionary? = nil) -> StructureDefinition {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "structuredefinition-example.canonical.json")
	...
	func testStructureDefinition2() {
		let instance = testStructureDefinition2_impl()
		testStructureDefinition2_impl(json: instance.asJSON())
	}
	
	func testStructureDefinition2_impl(json: JSONDictionary? = nil) -> StructureDefinition {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "structuredefinition-example.canonical.json")
	...
	func testStructureDefinition3() {
		let instance = testStructureDefinition3_impl()
		testStructureDefinition3_impl(json: instance.asJSON())
	}
	
	func testStructureDefinition3_impl(json: JSONDictionary? = nil) -> StructureDefinition {
