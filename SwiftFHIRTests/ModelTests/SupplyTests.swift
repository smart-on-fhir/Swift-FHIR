...
class SupplyTests: FHIRModelTestCase
{
	...
	func testSupply1_impl(json: JSONDictionary? = nil) -> Supply {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "supply-example1.canonical.json")
	...
	func testSupply2() {
		let instance = testSupply2_impl()
		testSupply2_impl(json: instance.asJSON())
	}
	
	func testSupply2_impl(json: JSONDictionary? = nil) -> Supply {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "supply-example1.canonical.json")
	...
	func testSupply3() {
		let instance = testSupply3_impl()
		testSupply3_impl(json: instance.asJSON())
	}
	
	func testSupply3_impl(json: JSONDictionary? = nil) -> Supply {
