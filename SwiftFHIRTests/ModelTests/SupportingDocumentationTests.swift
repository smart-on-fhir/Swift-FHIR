...
class SupportingDocumentationTests: FHIRModelTestCase
{
	...
	func testSupportingDocumentation1_impl(json: JSONDictionary? = nil) -> SupportingDocumentation {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "supportingdocumentation-example.canonical.json")
	...
	func testSupportingDocumentation2() {
		let instance = testSupportingDocumentation2_impl()
		testSupportingDocumentation2_impl(json: instance.asJSON())
	}
	
	func testSupportingDocumentation2_impl(json: JSONDictionary? = nil) -> SupportingDocumentation {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "supportingdocumentation-example.canonical.json")
	...
	func testSupportingDocumentation3() {
		let instance = testSupportingDocumentation3_impl()
		testSupportingDocumentation3_impl(json: instance.asJSON())
	}
	
	func testSupportingDocumentation3_impl(json: JSONDictionary? = nil) -> SupportingDocumentation {
