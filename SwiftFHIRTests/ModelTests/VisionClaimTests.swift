...
class VisionClaimTests: FHIRModelTestCase
{
	...
	func testVisionClaim1_impl(json: JSONDictionary? = nil) -> VisionClaim {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "visionclaim-example-glasses.canonical.json")
	...
	func testVisionClaim3() {
		let instance = testVisionClaim3_impl()
		testVisionClaim3_impl(json: instance.asJSON())
	}
	
	func testVisionClaim3_impl(json: JSONDictionary? = nil) -> VisionClaim {
	...
	func testVisionClaim4() {
		let instance = testVisionClaim4_impl()
		testVisionClaim4_impl(json: instance.asJSON())
	}
	
	func testVisionClaim4_impl(json: JSONDictionary? = nil) -> VisionClaim {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "visionclaim-example.canonical.json")
	...
	func testVisionClaim5() {
		let instance = testVisionClaim5_impl()
		testVisionClaim5_impl(json: instance.asJSON())
	}
	
	func testVisionClaim5_impl(json: JSONDictionary? = nil) -> VisionClaim {
