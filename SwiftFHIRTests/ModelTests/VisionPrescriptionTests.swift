...
class VisionPrescriptionTests: FHIRModelTestCase
{
	...
	func testVisionPrescription1_impl(json: JSONDictionary? = nil) -> VisionPrescription {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "visionprescription-example-1.canonical.json")
	...
	func testVisionPrescription3() {
		let instance = testVisionPrescription3_impl()
		testVisionPrescription3_impl(json: instance.asJSON())
	}
	
	func testVisionPrescription3_impl(json: JSONDictionary? = nil) -> VisionPrescription {
	...
	func testVisionPrescription4() {
		let instance = testVisionPrescription4_impl()
		testVisionPrescription4_impl(json: instance.asJSON())
	}
	
	func testVisionPrescription4_impl(json: JSONDictionary? = nil) -> VisionPrescription {
		let inst = (nil != json) ? instantiateFrom(json: json!) : instantiateFrom(filename: "visionprescription-example.canonical.json")
	...
	func testVisionPrescription5() {
		let instance = testVisionPrescription5_impl()
		testVisionPrescription5_impl(json: instance.asJSON())
	}
	
	func testVisionPrescription5_impl(json: JSONDictionary? = nil) -> VisionPrescription {
