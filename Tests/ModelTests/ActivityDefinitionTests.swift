...
class ActivityDefinitionTests: XCTestCase {
	...
	func instantiateFrom(filename filename: String) throws -> ActivityDefinition {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json json: FHIRJSON) -> ActivityDefinition {
		let instance = ActivityDefinition(json: json)
	...
	func runActivityDefinition1(json: FHIRJSON? = nil) throws -> ActivityDefinition {
