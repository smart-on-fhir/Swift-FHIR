...
class ActivityDefinitionTests: XCTestCase {
	...
	func runActivityDefinition1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRActivityDefinition {
		...
		XCTAssertEqual(inst.kind, RequestResourceType(rawValue: "ServiceRequest")!)
	...
	func runActivityDefinition2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRActivityDefinition {
		...
		XCTAssertEqual(inst.dosage?[0].doseAndRate?[0].type?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/dose-rate-type")
		...
		XCTAssertEqual(inst.dynamicValue?[0].expression?.description_fhir, "dispenseRequest.numberOfRepeatsAllowed is three (3)")
		XCTAssertEqual(inst.dynamicValue?[0].expression?.expression, "3")
		XCTAssertEqual(inst.dynamicValue?[0].expression?.language, "text/cql")
		XCTAssertEqual(inst.dynamicValue?[0].path, "dispenseRequest.numberOfRepeatsAllowed")
		XCTAssertEqual(inst.dynamicValue?[1].expression?.description_fhir, "dispenseRequest.quantity is thirty (30) tablets")
		XCTAssertEqual(inst.dynamicValue?[1].expression?.expression, "30 '{tbl}'")
		XCTAssertEqual(inst.dynamicValue?[1].expression?.language, "text/cql")
		...
		XCTAssertEqual(inst.jurisdiction?[0].coding?[0].code, "US")
		XCTAssertEqual(inst.jurisdiction?[0].coding?[0].system?.absoluteString, "urn:iso:std:iso:3166")
		XCTAssertEqual(inst.kind, RequestResourceType(rawValue: "MedicationRequest")!)
		XCTAssertEqual(inst.lastReviewDate?.description, "2016-08-15")
	...
	func runActivityDefinition5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRActivityDefinition {
		...
		XCTAssertEqual(inst.kind, RequestResourceType(rawValue: "SupplyRequest")!)
		XCTAssertEqual(inst.meta?.tag?[0].code, "HTEST")
		XCTAssertEqual(inst.meta?.tag?[0].display, "test health data")
		XCTAssertEqual(inst.meta?.tag?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
