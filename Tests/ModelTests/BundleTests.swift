...
class BundleTests: XCTestCase {
	...
	func runBundle6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRBundle {
		...
		XCTAssertEqual(inst.entry?[1].request?.method, HTTPVerb(rawValue: "POST")!)
		XCTAssertEqual(inst.entry?[1].request?.url?.absoluteString, "MolecularSequence")
		XCTAssertEqual(inst.entry?[2].fullUrl?.absoluteString, "urn:uuid:7c393185-f15c-45bc-a714-c0fdbea32675")
		XCTAssertEqual(inst.entry?[2].request?.method, HTTPVerb(rawValue: "POST")!)
		XCTAssertEqual(inst.entry?[2].request?.url?.absoluteString, "MolecularSequence")
		XCTAssertEqual(inst.entry?[3].fullUrl?.absoluteString, "urn:uuid:65c85f14-c3a0-4b72-818f-820e04fcc621")
		XCTAssertEqual(inst.entry?[3].request?.method, HTTPVerb(rawValue: "POST")!)
		XCTAssertEqual(inst.entry?[3].request?.url?.absoluteString, "MolecularSequence")
		XCTAssertEqual(inst.entry?[4].fullUrl?.absoluteString, "urn:uuid:fbba9fe7-0ece-4ec1-9233-a437a8d242a0")
		XCTAssertEqual(inst.entry?[4].request?.method, HTTPVerb(rawValue: "POST")!)
		XCTAssertEqual(inst.entry?[4].request?.url?.absoluteString, "MolecularSequence")
		...
		XCTAssertEqual(inst.entry?[5].request?.url?.absoluteString, "MolecularSequence")
		...
		XCTAssertEqual(inst.entry?[6].request?.url?.absoluteString, "MolecularSequence")
		...
		XCTAssertEqual(inst.entry?[7].request?.url?.absoluteString, "MolecularSequence")
		...
		XCTAssertEqual(inst.entry?[8].request?.url?.absoluteString, "MolecularSequence")
		...
		XCTAssertEqual(inst.entry?[9].request?.url?.absoluteString, "MolecularSequence")
	...
	func runBundle9(_ json: FHIRJSON? = nil) throws -> SwiftFHIRBundle {
		...
		XCTAssertEqual(inst.meta?.tag?[0].display, "test health data")
		XCTAssertEqual(inst.meta?.tag?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
		XCTAssertEqual(inst.signature?.onBehalfOf?.reference, "Organization/example")
		...
		XCTAssertEqual(inst.signature?.who?.reference, "Device/software")
