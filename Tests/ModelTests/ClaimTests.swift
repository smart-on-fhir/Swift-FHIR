...
class ClaimTests: XCTestCase {
	...
	func runClaim1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRClaim {
		...
		XCTAssertEqual(inst.information?[0].timingPeriod?.end?.description, "2014-08-16")
		XCTAssertEqual(inst.information?[0].timingPeriod?.start?.description, "2014-08-16")
		...
		XCTAssertEqual(inst.information?[1].timingPeriod?.end?.description, "2014-08-16")
		XCTAssertEqual(inst.information?[1].timingPeriod?.start?.description, "2014-08-15")
	...
	func runClaim5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRClaim {
		...
		XCTAssertEqual(inst.careTeam?[0].provider?.reference, "Practitioner/example")
		XCTAssertEqual(inst.careTeam?[0].sequence, 1)
		XCTAssertEqual(inst.contained?[0].id, "claimresponse-1")
		XCTAssertEqual(inst.contained?[1].id, "device-frame")
		XCTAssertEqual(inst.contained?[2].id, "device-lens")
		XCTAssertEqual(inst.created?.description, "2014-08-16")
		XCTAssertEqual(inst.diagnosis?[0].diagnosisCodeableConcept?.coding?[0].code, "654321")
		XCTAssertEqual(inst.diagnosis?[0].sequence, 1)
		...
		XCTAssertEqual(inst.insurance?[0].claimResponse?.reference, "#claimresponse-1")
		XCTAssertEqual(inst.insurance?[0].coverage?.reference, "Coverage/9876B1")
		...
		XCTAssertEqual(inst.item?[0].category?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/benefit-subcategory")
		...
		XCTAssertEqual(inst.item?[0].detail?[0].category?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/benefit-subcategory")
		XCTAssertEqual(inst.item?[0].detail?[0].factor, "1.1")
		XCTAssertEqual(inst.item?[0].detail?[0].modifier?[0].coding?[0].code, "rooh")
		XCTAssertEqual(inst.item?[0].detail?[0].modifier?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/modifiers")
		...
		XCTAssertEqual(inst.item?[0].detail?[0].revenue?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-revenue-center")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].category?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/benefit-subcategory")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].programCode?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-programcode")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].revenue?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-revenue-center")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[0].category?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/benefit-subcategory")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[0].modifier?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/modifiers")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[0].programCode?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-programcode")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[0].revenue?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-revenue-center")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[0].sequence, 1)
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[0].service?.coding?[0].code, "lens")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[0].service?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-visionservice")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[0].udi?[0].reference, "#device-lens")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[0].unitPrice?.code, "USD")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[0].unitPrice?.system?.absoluteString, "urn:iso:std:iso:4217")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[1].category?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/benefit-subcategory")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[1].modifier?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/modifiers")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[1].net?.code, "USD")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[1].net?.system?.absoluteString, "urn:iso:std:iso:4217")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[1].revenue?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-revenue-center")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[1].sequence, 2)
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[1].service?.coding?[0].code, "hardening")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[1].service?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-visionservice")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[1].unitPrice?.code, "USD")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[1].unitPrice?.system?.absoluteString, "urn:iso:std:iso:4217")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[2].category?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/benefit-subcategory")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[2].modifier?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/modifiers")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[2].net?.code, "USD")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[2].net?.system?.absoluteString, "urn:iso:std:iso:4217")
		...
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[2].revenue?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-revenue-center")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[2].sequence, 3)
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[2].service?.coding?[0].code, "UV coating")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[2].service?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-visionservice")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[2].unitPrice?.code, "USD")
		XCTAssertEqual(inst.item?[0].detail?[1].subDetail?[2].unitPrice?.system?.absoluteString, "urn:iso:std:iso:4217")
		...
		XCTAssertEqual(inst.item?[0].detail?[2].category?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/benefit-subcategory")
		...
		XCTAssertEqual(inst.item?[0].detail?[2].revenue?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-revenue-center")
		...
		XCTAssertEqual(inst.item?[0].modifier?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/modifiers")
		XCTAssertEqual(inst.item?[0].net?.code, "USD")
		XCTAssertEqual(inst.item?[0].net?.system?.absoluteString, "urn:iso:std:iso:4217")
		XCTAssertEqual(inst.item?[0].net?.value, "235.4")
		XCTAssertEqual(inst.item?[0].programCode?[0].coding?[0].code, "none")
		XCTAssertEqual(inst.item?[0].programCode?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-programcode")
		XCTAssertEqual(inst.item?[0].revenue?.coding?[0].code, "0010")
		XCTAssertEqual(inst.item?[0].revenue?.coding?[0].display, "Vision Clinic")
		XCTAssertEqual(inst.item?[0].revenue?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ex-revenue-center")
		XCTAssertEqual(inst.item?[0].sequence, 1)
	...
	func runClaim10(_ json: FHIRJSON? = nil) throws -> SwiftFHIRClaim {
		...
		XCTAssertEqual(inst.information?[0].category?.coding?[0].code, "hospitalized")
		XCTAssertEqual(inst.information?[0].category?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/claiminformationcategory")
		XCTAssertEqual(inst.information?[0].sequence, 1)
		XCTAssertEqual(inst.information?[0].timingPeriod?.end?.description, "2015-10-05T00:00:00-07:00")
		XCTAssertEqual(inst.information?[0].timingPeriod?.start?.description, "2015-10-01T00:00:00-07:00")
		XCTAssertEqual(inst.information?[1].category?.coding?[0].code, "discharge")
		XCTAssertEqual(inst.information?[1].category?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/claiminformationcategory")
		XCTAssertEqual(inst.information?[1].code?.coding?[0].code, "01")
		XCTAssertEqual(inst.information?[1].code?.coding?[0].display, "Discharge to Home or Self Care")
		XCTAssertEqual(inst.information?[1].code?.coding?[0].system?.absoluteString, "https://www.cms.gov/Outreach-and-Education/Medicare-Learning-Network-MLN/MLNMattersArticles/downloads/SE0801.pdf")
		XCTAssertEqual(inst.information?[1].sequence, 2)
		XCTAssertEqual(inst.insurance?[0].coverage?.reference, "#coverage-1")
		XCTAssertEqual(inst.insurance?[0].focal, true)
		...
		XCTAssertEqual(inst.item?[0].sequence, 1)
		XCTAssertEqual(inst.item?[0].service?.coding?[0].code, "62264")
		XCTAssertEqual(inst.item?[0].service?.coding?[0].display, "Surgical Procedures on the Spine and Spinal Cord")
		XCTAssertEqual(inst.item?[0].service?.coding?[0].system?.absoluteString, "http://www.ama-assn.org/go/cpt")
		...
		XCTAssertEqual(inst.provider?.reference, "Organization/1")
		XCTAssertEqual(inst.status, "active")
		XCTAssertEqual(inst.subType?[0].coding?[0].code, "831")
		XCTAssertEqual(inst.subType?[0].coding?[0].system?.absoluteString, "https://www.cms.gov/codes/billtype")
