...
class ClaimTests: XCTestCase {
	...
	func runClaim1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRClaim {
		...
		XCTAssertEqual(inst.accident?.type?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ValueSet/v3-ActIncidentCode")
		...
		XCTAssertEqual(inst.careTeam?[0].qualification?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ValueSet/provider-qualification")
		XCTAssertEqual(inst.careTeam?[0].responsible, true)
		XCTAssertEqual(inst.careTeam?[0].role?.coding?[0].code, "primary")
		XCTAssertEqual(inst.careTeam?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ValueSet/claim-careteamrole")
		...
		XCTAssertEqual(inst.diagnosis?[0].packageCode?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/ValueSet/ex-diagnosisrelatedgroup")
		XCTAssertEqual(inst.diagnosis?[0].sequence, 1)
		XCTAssertEqual(inst.diagnosis?[0].type?[0].coding?[0].code, "admitting")
		XCTAssertEqual(inst.diagnosis?[0].type?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/ValueSet/ex-diagnosistype")
