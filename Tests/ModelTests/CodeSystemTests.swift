...
class CodeSystemTests: XCTestCase {
	...
	func instantiateFrom(filename filename: String) throws -> CodeSystem {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json json: FHIRJSON) -> CodeSystem {
		let instance = CodeSystem(json: json)
	...
	func runCodeSystem2(json: FHIRJSON? = nil) throws -> CodeSystem {
