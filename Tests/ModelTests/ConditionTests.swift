...
class ConditionTests: XCTestCase {
	...
	func runCondition1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCondition {
		...
		XCTAssertEqual(inst.clinicalStatus?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-clinical")
		...
		XCTAssertEqual(inst.recordedDate?.description, "2012-02-20")
		...
		XCTAssertEqual(inst.verificationStatus?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-ver-status")
	...
	func runCondition2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCondition {
		...
		XCTAssertEqual(inst.category?[0].coding?[1].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-category")
		XCTAssertEqual(inst.clinicalStatus?.coding?[0].code, "active")
		XCTAssertEqual(inst.clinicalStatus?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-clinical")
		XCTAssertEqual(inst.code?.coding?[0].code, "10001005")
		XCTAssertEqual(inst.code?.coding?[0].display, "Bacterial sepsis")
		XCTAssertEqual(inst.code?.coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.encounter?.display, "Roel's encounter on March elevanth")
		...
		XCTAssertEqual(inst.recordedDate?.description, "2013-03-11")
	...
	func runCondition3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCondition {
		...
		XCTAssertEqual(inst.category?[0].coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-category")
		XCTAssertEqual(inst.clinicalStatus?.coding?[0].code, "active")
		XCTAssertEqual(inst.clinicalStatus?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-clinical")
	...
	func runCondition5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCondition {
		...
		XCTAssertEqual(inst.recordedDate?.description, "2012-06-03")
		XCTAssertEqual(inst.severity?.coding?[0].code, "24484000")
		XCTAssertEqual(inst.severity?.coding?[0].display, "Severe")
		XCTAssertEqual(inst.severity?.coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.stage?[0].summary?.coding?[0].code, "258219007")
		XCTAssertEqual(inst.stage?[0].summary?.coding?[0].display, "stage II")
		XCTAssertEqual(inst.stage?[0].summary?.coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.stage?[0].type?.coding?[0].code, "260998006")
		XCTAssertEqual(inst.stage?[0].type?.coding?[0].display, "Clinical staging (qualifier value)")
		XCTAssertEqual(inst.stage?[0].type?.coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.subject?.display, "P. van de Heuvel")
		XCTAssertEqual(inst.subject?.reference, "Patient/f001")
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
		XCTAssertEqual(inst.verificationStatus?.coding?[0].code, "confirmed")
	...
	func runCondition6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCondition {
		...
		XCTAssertEqual(inst.meta?.tag?[0].display, "test health data")
		XCTAssertEqual(inst.meta?.tag?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
		XCTAssertEqual(inst.recordedDate?.description, "2013-04-04")
		XCTAssertEqual(inst.subject?.display, "Roel")
		XCTAssertEqual(inst.subject?.reference, "Patient/f201")
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
		XCTAssertEqual(inst.verificationStatus?.coding?[0].code, "differential")
		XCTAssertEqual(inst.verificationStatus?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-ver-status")
	...
	func runCondition7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCondition {
		...
		XCTAssertEqual(inst.category?[0].coding?[1].code, "problem-list-item")
		XCTAssertEqual(inst.category?[0].coding?[1].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-category")
		XCTAssertEqual(inst.clinicalStatus?.coding?[0].code, "inactive")
		XCTAssertEqual(inst.clinicalStatus?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-clinical")
		...
		XCTAssertEqual(inst.severity?.coding?[0].display, "Severe")
		XCTAssertEqual(inst.severity?.coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.stage?[0].assessment?[0].display, "Genetic analysis master panel")
		XCTAssertEqual(inst.stage?[0].summary?.coding?[0].code, "14803004")
		XCTAssertEqual(inst.stage?[0].summary?.coding?[0].display, "Temporary")
		XCTAssertEqual(inst.stage?[0].summary?.coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.subject?.display, "Roel")
		XCTAssertEqual(inst.subject?.reference, "Patient/f201")
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
	...
	func runCondition8(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCondition {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "condition-example2.json")
	...
	func runCondition9(_ json: FHIRJSON? = nil) throws -> SwiftFHIRCondition {
		...
		XCTAssertEqual(inst.category?[0].coding?[0].code, "encounter-diagnosis")
		XCTAssertEqual(inst.category?[0].coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-category")
		XCTAssertEqual(inst.clinicalStatus?.coding?[0].code, "resolved")
		XCTAssertEqual(inst.clinicalStatus?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/condition-clinical")
		...
		XCTAssertEqual(inst.meta?.security?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-ActCode")
		XCTAssertEqual(inst.meta?.tag?[0].code, "HTEST")
		XCTAssertEqual(inst.meta?.tag?[0].display, "test health data")
		XCTAssertEqual(inst.meta?.tag?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
		...
		XCTAssertEqual(inst.recordedDate?.description, "2012-12-01")
		XCTAssertEqual(inst.severity?.coding?[0].code, "24484000")
		XCTAssertEqual(inst.severity?.coding?[0].display, "Severe")
		XCTAssertEqual(inst.severity?.coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.subject?.display, "Roel")
