...
class ConsentTests: XCTestCase {
	...
	func runConsent1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		...
		XCTAssertEqual(inst.policyRule?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		...
		XCTAssertEqual(inst.scope?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentscope")
		XCTAssertEqual(inst.sourceAttachment?.title, "The terms of the consent in lawyer speak.")
		XCTAssertEqual(inst.status, EventStatus(rawValue: "in-progress")!)
	...
	func runConsent2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		...
		XCTAssertEqual(inst.provision?.provision?[0].action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
	...
	func runConsent3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		...
		XCTAssertEqual(inst.provision?.actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.scope?.coding?[0].code, "patient-privacy")
		XCTAssertEqual(inst.scope?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentscope")
		XCTAssertEqual(inst.sourceAttachment?.title, "The terms of the consent in lawyer speak.")
		XCTAssertEqual(inst.status, EventStatus(rawValue: "in-progress")!)
	...
	func runConsent5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		...
		XCTAssertEqual(inst.provision?.provision?[0].actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
	...
	func runConsent6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		...
		XCTAssertEqual(inst.provision?.action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
		XCTAssertEqual(inst.provision?.action?[1].coding?[0].code, "correct")
		XCTAssertEqual(inst.provision?.action?[1].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
	...
	func runConsent7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		...
		XCTAssertEqual(inst.category?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		XCTAssertEqual(inst.dateTime?.description, "2015-11-18")
		...
		XCTAssertEqual(inst.provision?.actor?[1].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.scope?.coding?[0].code, "patient-privacy")
		XCTAssertEqual(inst.scope?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentscope")
		XCTAssertEqual(inst.sourceAttachment?.title, "The terms of the consent in lawyer speak.")
		XCTAssertEqual(inst.status, EventStatus(rawValue: "in-progress")!)
	...
	func runConsent9(_ json: FHIRJSON? = nil) throws -> SwiftFHIRConsent {
		...
		XCTAssertEqual(inst.provision?.provision?[0].securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		XCTAssertEqual(inst.provision?.provision?[1].action?[0].coding?[0].code, "access")
		XCTAssertEqual(inst.provision?.provision?[1].action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
		...
		XCTAssertEqual(inst.provision?.provision?[1].actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.provision?.provision?[1].securityLabel?[0].code, "SPI")
		XCTAssertEqual(inst.provision?.provision?[1].securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		XCTAssertEqual(inst.provision?.provision?[2].action?[0].coding?[0].code, "access")
		XCTAssertEqual(inst.provision?.provision?[2].action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
		...
		XCTAssertEqual(inst.provision?.provision?[2].actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.provision?.provision?[2].securityLabel?[0].code, "N")
		XCTAssertEqual(inst.provision?.provision?[2].securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/Confidentiality")
		XCTAssertEqual(inst.provision?.provision?[3].action?[0].coding?[0].code, "access")
		XCTAssertEqual(inst.provision?.provision?[3].action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
		...
		XCTAssertEqual(inst.provision?.provision?[3].actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.provision?.provision?[3].securityLabel?[0].code, "PSY")
		XCTAssertEqual(inst.provision?.provision?[3].securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		XCTAssertEqual(inst.provision?.provision?[4].action?[0].coding?[0].code, "access")
		XCTAssertEqual(inst.provision?.provision?[4].action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
		...
		XCTAssertEqual(inst.provision?.provision?[4].actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.provision?.provision?[4].securityLabel?[0].code, "SPI")
		XCTAssertEqual(inst.provision?.provision?[4].securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		XCTAssertEqual(inst.provision?.provision?[5].action?[0].coding?[0].code, "access")
		XCTAssertEqual(inst.provision?.provision?[5].action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
		...
		XCTAssertEqual(inst.provision?.provision?[5].actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.provision?.provision?[5].securityLabel?[0].code, "SEX")
		XCTAssertEqual(inst.provision?.provision?[5].securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		XCTAssertEqual(inst.provision?.provision?[6].action?[0].coding?[0].code, "access")
		XCTAssertEqual(inst.provision?.provision?[6].action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
		...
		XCTAssertEqual(inst.provision?.provision?[6].actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.provision?.provision?[6].securityLabel?[0].code, "N")
		XCTAssertEqual(inst.provision?.provision?[6].securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/Confidentiality")
		XCTAssertEqual(inst.provision?.provision?[7].action?[0].coding?[0].code, "access")
		XCTAssertEqual(inst.provision?.provision?[7].action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
		...
		XCTAssertEqual(inst.provision?.provision?[7].actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.provision?.provision?[7].securityLabel?[0].code, "PSY")
		XCTAssertEqual(inst.provision?.provision?[7].securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		XCTAssertEqual(inst.provision?.provision?[8].action?[0].coding?[0].code, "access")
		XCTAssertEqual(inst.provision?.provision?[8].action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
		...
		XCTAssertEqual(inst.provision?.provision?[8].actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.provision?.provision?[8].securityLabel?[0].code, "SPI")
		XCTAssertEqual(inst.provision?.provision?[8].securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		XCTAssertEqual(inst.provision?.provision?[9].action?[0].coding?[0].code, "access")
		XCTAssertEqual(inst.provision?.provision?[9].action?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentaction")
		...
		XCTAssertEqual(inst.provision?.provision?[9].actor?[0].role?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
		XCTAssertEqual(inst.provision?.provision?[9].securityLabel?[0].code, "SEX")
		XCTAssertEqual(inst.provision?.provision?[9].securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ActCode")
		XCTAssertEqual(inst.provision?.securityLabel?[0].code, "N")
		XCTAssertEqual(inst.provision?.securityLabel?[0].system?.absoluteString, "http://hl7.org/fhir/v3/Confidentiality")
		XCTAssertEqual(inst.scope?.coding?[0].code, "patient-privacy")
		XCTAssertEqual(inst.scope?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/consentscope")
		XCTAssertEqual(inst.status, EventStatus(rawValue: "in-progress")!)
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
