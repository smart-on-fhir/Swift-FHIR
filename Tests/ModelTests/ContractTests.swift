...
class ContractTests: XCTestCase {
	...
	func runContract2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		...
		XCTAssertEqual(inst.meta?.tag?[0].display, "test health data")
		XCTAssertEqual(inst.meta?.tag?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
		XCTAssertEqual(inst.subject?[0].reference, "Patient/1")
		XCTAssertEqual(inst.term?[0].asset?[0].period?[0].start?.description, "2017-06-01")
		XCTAssertEqual(inst.term?[0].asset?[0].subtype?[0].text, "sample")
		XCTAssertEqual(inst.term?[0].asset?[0].type?[0].coding?[0].code, "RicardianContract")
		XCTAssertEqual(inst.term?[0].asset?[0].type?[0].coding?[0].system?.absoluteString, "urn:ietf:rfc:3986")
		...
		XCTAssertEqual(inst.term?[0].asset?[0].valuedItem?[0].net?.currency, "CAD")
		...
		XCTAssertEqual(inst.term?[0].asset?[0].valuedItem?[0].unitPrice?.currency, "CAD")
		...
		XCTAssertEqual(inst.type?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/contract-type")
	...
	func runContract3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		...
		XCTAssertEqual(inst.contentDerivative?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/contract-content-derivative")
		...
		XCTAssertEqual(inst.signer?[0].signature?[0].who?.reference, "Patient/f201")
		XCTAssertEqual(inst.signer?[0].type?.code, "SELF")
		XCTAssertEqual(inst.signer?[0].type?.system?.absoluteString, "http://mdhhs.org/fhir/consent-signer-type")
		XCTAssertEqual(inst.status, ContractResourceStatusCodes(rawValue: "executed")!)
		XCTAssertEqual(inst.subType?[0].coding?[0].code, "hcd")
		XCTAssertEqual(inst.subType?[0].coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/consentcategorycodes")
		XCTAssertEqual(inst.subject?[0].reference, "Patient/f201")
		XCTAssertEqual(inst.term?[0].action?[0].intent?.coding?[0].code, "HPRGRP")
		XCTAssertEqual(inst.term?[0].action?[0].intent?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
		XCTAssertEqual(inst.term?[0].action?[0].status?.text, "Sample")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[0].reference?[0].display, "VA Ann Arbor Healthcare System")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[0].reference?[0].reference, "Organization/f001")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[0].role?.coding?[0].code, "IR")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[0].role?.coding?[0].display, "Recipient")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[0].role?.coding?[0].system?.absoluteString, "http://mdhhs.org/fhir/consent-actor-type")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[0].role?.text, "Recipient of restricted health information")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[1].reference?[0].display, "Community Mental Health Clinic")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[1].reference?[0].reference, "Organization/2")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[1].role?.coding?[0].code, "IS")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[1].role?.coding?[0].display, "Sender")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[1].role?.coding?[0].system?.absoluteString, "http://mdhhs.org/fhir/consent-actor-type")
		XCTAssertEqual(inst.term?[0].action?[0].subject?[1].role?.text, "Sender of restricted health information")
		XCTAssertEqual(inst.term?[0].action?[0].type?.coding?[0].code, "action-a")
		XCTAssertEqual(inst.term?[0].action?[0].type?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/contractaction")
		XCTAssertEqual(inst.term?[0].asset?[0].period?[0].end?.description, "2019-11-01T21:18:27-04:00")
		XCTAssertEqual(inst.term?[0].asset?[0].period?[0].start?.description, "2013-11-01T21:18:27-04:00")
		XCTAssertEqual(inst.term?[0].offer?.decision?.coding?[0].code, "OPTIN")
		XCTAssertEqual(inst.term?[0].offer?.decision?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-ActCode")
		XCTAssertEqual(inst.term?[0].offer?.text, "Can't refuse")
		XCTAssertEqual(inst.term?[0].offer?.type?.coding?[0].code, "statutory")
		XCTAssertEqual(inst.term?[0].offer?.type?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/contracttermtypecodes")
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
		XCTAssertEqual(inst.type?.coding?[0].code, "OPTIN")
		XCTAssertEqual(inst.type?.coding?[0].system?.absoluteString, "http://mdhhs.org/fhir/consentdirective-type")
	...
	func runContract5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		...
		XCTAssertEqual(inst.signer?[0].signature?[0].who?.reference, "Patient/f001")
		XCTAssertEqual(inst.signer?[0].type?.code, "COVPTY")
		XCTAssertEqual(inst.signer?[0].type?.system?.absoluteString, "http://terminology.hl7.org/CodeSystem/contractsignertypecodes")
		XCTAssertEqual(inst.subType?[0].coding?[0].code, "Opt-In")
		XCTAssertEqual(inst.subType?[0].coding?[0].display, "Default Authorization with exceptions.")
		XCTAssertEqual(inst.subType?[0].coding?[0].system?.absoluteString, "http://www.infoway-inforoute.ca.org/Consent-subtype-codes")
		XCTAssertEqual(inst.subject?[0].display, "P. van de Heuvel")
	...
	func runContract7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRContract {
		...
		XCTAssertEqual(inst.meta?.tag?[0].display, "test health data")
		XCTAssertEqual(inst.meta?.tag?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
		XCTAssertEqual(inst.rule?[0].contentAttachment?.contentType, "application/txt")
		XCTAssertEqual(inst.rule?[0].contentAttachment?.url?.absoluteString, "http://www.rfc-editor.org/bcp/bcp13.txt")
		XCTAssertEqual(inst.term?[0].asset?[0].period?[0].start?.description, "2017-06-01")
		XCTAssertEqual(inst.term?[0].asset?[0].subtype?[0].text, "sample")
		XCTAssertEqual(inst.term?[0].asset?[0].type?[0].coding?[0].code, "RicardianContract")
		XCTAssertEqual(inst.term?[0].asset?[0].type?[0].coding?[0].system?.absoluteString, "urn:ietf:rfc:3986")
