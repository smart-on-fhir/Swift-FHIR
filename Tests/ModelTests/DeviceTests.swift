...
class DeviceTests: XCTestCase {
	...
	func runDevice5(json: FHIRJSON? = nil) throws -> Device {
	...
	func runDevice6(json: FHIRJSON? = nil) throws -> Device {
	...
	func runDevice7(json: FHIRJSON? = nil) throws -> Device {
	...
	func runDevice8(json: FHIRJSON? = nil) throws -> Device {
	...
	func runDevice9(json: FHIRJSON? = nil) throws -> Device {
