...
class EndpointTests: XCTestCase {
	...
	func instantiateFrom(filename filename: String) throws -> Endpoint {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json json: FHIRJSON) -> Endpoint {
		let instance = Endpoint(json: json)
	...
	func runEndpoint1(json: FHIRJSON? = nil) throws -> Endpoint {
