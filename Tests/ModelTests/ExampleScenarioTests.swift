...
class ExampleScenarioTests: XCTestCase {
	...
	func runExampleScenario1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRExampleScenario {
		...
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.name, "Check if patient took drugs")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[0].description_fhir, "Yes, patient took drugs")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[0].step?[0].process?[0].step?[0].operation?.initiator, "Nurse")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[0].step?[0].process?[0].step?[0].operation?.initiatorActive, true)
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[0].step?[0].process?[0].step?[0].operation?.name, "Register Meds taken")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[0].step?[0].process?[0].step?[0].operation?.number, "1a")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[0].step?[0].process?[0].step?[0].operation?.receiver, "MAP")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[0].step?[0].process?[0].title, "Register Meds taken")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[1].description_fhir, "No, patient did not take drugs")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[1].step?[0].process?[0].step?[0].operation?.initiator, "Nurse")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[1].step?[0].process?[0].step?[0].operation?.initiatorActive, true)
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[1].step?[0].process?[0].step?[0].operation?.name, "Register Meds NOT taken")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[1].step?[0].process?[0].step?[0].operation?.number, "1b")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[1].step?[0].process?[0].step?[0].operation?.receiver, "MAP")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[1].step?[0].process?[0].title, "Register Meds NOT taken")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[2].description_fhir, "Not clear")
		XCTAssertEqual(inst.process?[0].step?[7].alternative?.option?[2].step?[0].pause, true)
