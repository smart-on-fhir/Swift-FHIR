...
class ImagingExcerptTests: XCTestCase {
	...
	func instantiateFrom(filename filename: String) throws -> ImagingExcerpt {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json json: FHIRJSON) -> ImagingExcerpt {
		let instance = ImagingExcerpt(json: json)
	...
	func runImagingExcerpt1(json: FHIRJSON? = nil) throws -> ImagingExcerpt {
