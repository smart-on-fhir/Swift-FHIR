...
class ImagingManifestTests: XCTestCase {
	...
	func instantiateFrom(filename filename: String) throws -> ImagingManifest {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json json: FHIRJSON) -> ImagingManifest {
		let instance = ImagingManifest(json: json)
	...
	func runImagingManifest1(json: FHIRJSON? = nil) throws -> ImagingManifest {
