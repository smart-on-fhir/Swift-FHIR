...
class ImagingStudyTests: XCTestCase {
	...
	func runImagingStudy1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRImagingStudy {
		...
		XCTAssertEqual(inst.series?[0].identifier?.system?.absoluteString, "urn:ietf:rfc:3986")
		XCTAssertEqual(inst.series?[0].identifier?.use, IdentifierUse(rawValue: "official")!)
		XCTAssertEqual(inst.series?[0].identifier?.value, "urn:oid:2.16.124.113543.6003.1154777499.30246.19789.3503430045.1")
		XCTAssertEqual(inst.series?[0].instance?[0].identifier?.system?.absoluteString, "urn:ietf:rfc:3986")
		XCTAssertEqual(inst.series?[0].instance?[0].identifier?.use, IdentifierUse(rawValue: "official")!)
		XCTAssertEqual(inst.series?[0].instance?[0].identifier?.value, "urn:oid:2.16.124.113543.6003.1154777499.30246.19789.3503430045.1.1")
		...
		XCTAssertEqual(inst.series?[0].instance?[1].identifier?.system?.absoluteString, "urn:ietf:rfc:3986")
		XCTAssertEqual(inst.series?[0].instance?[1].identifier?.use, IdentifierUse(rawValue: "official")!)
		XCTAssertEqual(inst.series?[0].instance?[1].identifier?.value, "urn:oid:2.16.124.113543.6003.1154777499.30246.19789.3503430045.1.2")
		...
		XCTAssertEqual(inst.series?[0].performer?[0].function?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/v3/ParticipationType")
	...
	func runImagingStudy2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRImagingStudy {
		...
		XCTAssertEqual(inst.series?[0].identifier?.system?.absoluteString, "urn:ietf:rfc:3986")
		XCTAssertEqual(inst.series?[0].identifier?.value, "urn:oid:2.16.124.113543.6003.2588828330.45298.17418.2723805630")
		XCTAssertEqual(inst.series?[0].instance?[0].identifier?.system?.absoluteString, "urn:ietf:rfc:3986")
		XCTAssertEqual(inst.series?[0].instance?[0].identifier?.value, "urn:oid:2.16.124.113543.6003.189642796.63084.16748.2599092903")
		XCTAssertEqual(inst.series?[0].instance?[0].number, 1)
		XCTAssertEqual(inst.series?[0].instance?[0].sopClass?.code, "urn:oid:1.2.840.10008.5.1.4.1.1.2")
		XCTAssertEqual(inst.series?[0].instance?[0].sopClass?.system?.absoluteString, "urn:ietf:rfc:3986")
