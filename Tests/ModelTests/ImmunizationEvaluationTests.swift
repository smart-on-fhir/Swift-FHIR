...
class ImmunizationEvaluationTests: XCTestCase {
	...
	func runImmunizationEvaluation1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRImmunizationEvaluation {
		...
		XCTAssertEqual(inst.doseStatus?.coding?[0].system?.absoluteString, "http://hl7.org/fhir/vaccination-protocol-dose-status")
		...
		XCTAssertEqual(inst.targetDisease?[0].coding?[0].code, "1857005")
		XCTAssertEqual(inst.targetDisease?[0].coding?[0].system?.absoluteString, "http://snomed.info/sct")
	...
	func runImmunizationEvaluation2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRImmunizationEvaluation {
		...
		XCTAssertEqual(inst.doseStatusReason?[0].coding?[0].system?.absoluteString, "http://hl7.org/fhir/vaccination-protocol-dose-status-reason")
