...
class LibraryTests: XCTestCase {
	...
	func instantiateFrom(filename filename: String) throws -> Library {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json json: FHIRJSON) -> Library {
		let instance = Library(json: json)
	...
	func runLibrary1(json: FHIRJSON? = nil) throws -> Library {
	...
	func runLibrary2(json: FHIRJSON? = nil) throws -> Library {
