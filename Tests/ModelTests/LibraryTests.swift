...
class LibraryTests: XCTestCase {
	...
	func runLibrary2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLibrary {
		...
		XCTAssertEqual(inst.dataRequirement?[1].codeFilter?[2].valueSetUri?.absoluteString, "urn:oid:2.16.840.1.113883.3.464.1003.102.12.1011")
		...
		XCTAssertEqual(inst.dataRequirement?[2].codeFilter?[2].valueSetUri?.absoluteString, "urn:oid:2.16.840.1.113883.3.464.1003.102.12.1012")
		...
		XCTAssertEqual(inst.dataRequirement?[3].codeFilter?[2].valueSetUri?.absoluteString, "urn:oid:2.16.840.1.113883.3.464.1003.101.12.1061")
		XCTAssertEqual(inst.dataRequirement?[3].type, "Encounter")
		XCTAssertEqual(inst.dataRequirement?[4].codeFilter?[0].path, "diagnosis")
		XCTAssertEqual(inst.dataRequirement?[4].codeFilter?[0].valueSetUri?.absoluteString, "urn:oid:2.16.840.1.113883.3.464.1003.198.12.1012")
		XCTAssertEqual(inst.dataRequirement?[4].type, "DiagnosticReport")
		XCTAssertEqual(inst.dataRequirement?[5].codeFilter?[0].path, "code")
		XCTAssertEqual(inst.dataRequirement?[5].codeFilter?[0].valueSetUri?.absoluteString, "urn:oid:2.16.840.1.113883.3.464.1003.196.12.1001")
		...
		XCTAssertEqual(inst.dataRequirement?[6].codeFilter?[1].valueSetUri?.absoluteString, "urn:oid:2.16.840.1.113883.3.464.1003.196.12.1001")
		...
		XCTAssertEqual(inst.dataRequirement?[7].codeFilter?[1].valueSetUri?.absoluteString, "urn:oid:2.16.840.1.113883.3.464.1003.196.12.1001")
	...
	func runLibrary3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLibrary {
		...
		XCTAssertEqual(inst.dataRequirement?[0].codeFilter?[0].valueSetUri?.absoluteString, "uin:oid:2.16.840.1.113883.3.464.1003.111.12.1006")
