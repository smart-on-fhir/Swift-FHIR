...
class LocationTests: XCTestCase {
	...
	func runLocation1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		...
		XCTAssertEqual(inst.alias?[0], "BU MC, SW, F2")
		XCTAssertEqual(inst.alias?[1], "Burgers University Medical Center, South Wing, second floor")
		...
		XCTAssertEqual(inst.physicalType?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/location-physical-type")
	...
	func runLocation2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		...
		XCTAssertEqual(inst.operationalStatus?.system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v2-0116")
		...
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
		XCTAssertEqual(inst.type?[0].coding?[0].code, "RNEU")
		XCTAssertEqual(inst.type?[0].coding?[0].display, "Neuroradiology unit")
		XCTAssertEqual(inst.type?[0].coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-RoleCode")
	...
	func runLocation3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		...
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
		XCTAssertEqual(inst.type?[0].coding?[0].code, "AMB")
		XCTAssertEqual(inst.type?[0].coding?[0].display, "Ambulance")
		XCTAssertEqual(inst.type?[0].coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-RoleCode")
	...
	func runLocation4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		...
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
		XCTAssertEqual(inst.type?[0].coding?[0].code, "PHARM")
		XCTAssertEqual(inst.type?[0].coding?[0].display, "Pharmacy")
		XCTAssertEqual(inst.type?[0].coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-RoleCode")
	...
	func runLocation5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		...
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
		XCTAssertEqual(inst.type?[0].coding?[0].code, "PTRES")
		XCTAssertEqual(inst.type?[0].coding?[0].display, "Patient's Residence")
		XCTAssertEqual(inst.type?[0].coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-RoleCode")
	...
	func runLocation6(_ json: FHIRJSON? = nil) throws -> SwiftFHIRLocation {
		...
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
		XCTAssertEqual(inst.type?[0].coding?[0].code, "SLEEP")
		XCTAssertEqual(inst.type?[0].coding?[0].display, "Sleep disorders unit")
		XCTAssertEqual(inst.type?[0].coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-RoleCode")
