...
class MeasureReportTests: XCTestCase {
	...
	func instantiateFrom(filename filename: String) throws -> MeasureReport {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json json: FHIRJSON) -> MeasureReport {
		let instance = MeasureReport(json: json)
	...
	func runMeasureReport1(json: FHIRJSON? = nil) throws -> MeasureReport {
	...
	func runMeasureReport2(json: FHIRJSON? = nil) throws -> MeasureReport {
	...
	func runMeasureReport3(json: FHIRJSON? = nil) throws -> MeasureReport {
