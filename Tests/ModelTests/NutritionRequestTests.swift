...
class NutritionRequestTests: XCTestCase {
	...
	func instantiateFrom(filename filename: String) throws -> NutritionRequest {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json json: FHIRJSON) -> NutritionRequest {
		let instance = NutritionRequest(json: json)
	...
	func runNutritionRequest1(json: FHIRJSON? = nil) throws -> NutritionRequest {
	...
	func runNutritionRequest2(json: FHIRJSON? = nil) throws -> NutritionRequest {
	...
	func runNutritionRequest3(json: FHIRJSON? = nil) throws -> NutritionRequest {
	...
	func runNutritionRequest4(json: FHIRJSON? = nil) throws -> NutritionRequest {
	...
	func runNutritionRequest5(json: FHIRJSON? = nil) throws -> NutritionRequest {
	...
	func runNutritionRequest6(json: FHIRJSON? = nil) throws -> NutritionRequest {
	...
	func runNutritionRequest7(json: FHIRJSON? = nil) throws -> NutritionRequest {
	...
	func runNutritionRequest8(json: FHIRJSON? = nil) throws -> NutritionRequest {
	...
	func runNutritionRequest9(json: FHIRJSON? = nil) throws -> NutritionRequest {
	...
	func runNutritionRequest10(json: FHIRJSON? = nil) throws -> NutritionRequest {
