...
class ObservationTests: XCTestCase {
	...
	func runObservation1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		...
		XCTAssertEqual(inst.extension_fhir?[0].url?.absoluteString, "http://hl7.org/fhir/StructureDefinition/observation-geneticsGene")
		...
		XCTAssertEqual(inst.extension_fhir?[1].url?.absoluteString, "http://hl7.org/fhir/StructureDefinition/observation-geneticsDNARegionName")
		XCTAssertEqual(inst.extension_fhir?[1].valueString, "Exon 21")
		XCTAssertEqual(inst.extension_fhir?[2].url?.absoluteString, "http://hl7.org/fhir/StructureDefinition/observation-geneticsGenomicSourceClass")
	...
	func runObservation5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		...
		XCTAssertEqual(inst.code?.coding?[0].display, "Genetic analysis master panel-- This is the parent OBR for the panel holding all of the associated observations that can be reported with a molecular genetics analysis result.")
		XCTAssertEqual(inst.code?.coding?[0].system?.absoluteString, "http://loinc.org")
		XCTAssertEqual(inst.derivedFrom?[0].reference, "Sequence/example-pgx-1")
		XCTAssertEqual(inst.derivedFrom?[1].reference, "Sequence/example-pgx-2")
		XCTAssertEqual(inst.extension_fhir?[0].url?.absoluteString, "http://hl7.org/fhir/StructureDefinition/observation-geneticsGene")
	...
	func runObservation7(_ json: FHIRJSON? = nil) throws -> SwiftFHIRObservation {
		...
		XCTAssertEqual(inst.extension_fhir?[1].url?.absoluteString, "http://hl7.org/fhir/us/core/StructureDefinition/us-core-ethnicity")
