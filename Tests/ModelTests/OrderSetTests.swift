...
class OrderSetTests: XCTestCase {
	...
	func instantiateFrom(filename: String) throws -> SwiftFHIR.OrderSet {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json: FHIRJSON) -> SwiftFHIR.OrderSet {
		let instance = SwiftFHIR.OrderSet(json: json)
	...
	@discardableResult
	func runOrderSet1(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.OrderSet {
