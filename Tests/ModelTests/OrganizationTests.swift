...
class OrganizationTests: XCTestCase {
	...
	func runOrganization1(_ json: FHIRJSON? = nil) throws -> SwiftFHIROrganization {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "organization-example.json")
	...
	func runOrganization4(_ json: FHIRJSON? = nil) throws -> SwiftFHIROrganization {
		let inst = (nil != json) ? try instantiateFrom(json: json!) : try instantiateFrom(filename: "organization-example-mihealth.json")
		
		XCTAssertEqual(inst.alias?[0], "Michigan State Department of Health")
		XCTAssertEqual(inst.id, "3")
		XCTAssertEqual(inst.identifier?[0].system?.absoluteString, "http://michigan.gov/state-dept-ids")
		XCTAssertEqual(inst.identifier?[0].value, "25")
		XCTAssertEqual(inst.meta?.tag?[0].code, "HTEST")
		XCTAssertEqual(inst.meta?.tag?[0].display, "test health data")
		XCTAssertEqual(inst.meta?.tag?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
		XCTAssertEqual(inst.name, "Michigan Health")
		XCTAssertEqual(inst.text?.status, NarrativeStatus(rawValue: "generated")!)
	...
	func runOrganization6(_ json: FHIRJSON? = nil) throws -> SwiftFHIROrganization {
		...
		XCTAssertEqual(inst.contact?[0].purpose?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/contactentity-type")
		...
		XCTAssertEqual(inst.type?[0].coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/organization-type")
	...
	func runOrganization7(_ json: FHIRJSON? = nil) throws -> SwiftFHIROrganization {
		...
		XCTAssertEqual(inst.type?[0].coding?[2].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/organization-type")
	...
	func runOrganization9(_ json: FHIRJSON? = nil) throws -> SwiftFHIROrganization {
		...
		XCTAssertEqual(inst.contact?[1].purpose?.coding?[0].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/contactentity-type")
		...
		XCTAssertEqual(inst.type?[0].coding?[1].system?.absoluteString, "http://terminology.hl7.org/CodeSystem/organization-type")
