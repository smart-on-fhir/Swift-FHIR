...
class PlanDefinitionTests: XCTestCase {
	...
	func instantiateFrom(filename filename: String) throws -> PlanDefinition {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json json: FHIRJSON) -> PlanDefinition {
		let instance = PlanDefinition(json: json)
	...
	func runPlanDefinition1(json: FHIRJSON? = nil) throws -> PlanDefinition {
	...
	func runPlanDefinition2(json: FHIRJSON? = nil) throws -> PlanDefinition {
