...
class PlanDefinitionTests: XCTestCase {
	...
	func runPlanDefinition1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRPlanDefinition {
		...
		XCTAssertEqual(inst.action?[0].action?[0].action?[0].action?[0].action?[0].definition?.absoluteString, "#1111")
		...
		XCTAssertEqual(inst.action?[0].action?[0].action?[0].action?[0].action?[1].definition?.absoluteString, "#2222")
	...
	func runPlanDefinition2(_ json: FHIRJSON? = nil) throws -> SwiftFHIRPlanDefinition {
		...
		XCTAssertEqual(inst.action?[0].action?[0].definition?.absoluteString, "#activitydefinition-medicationrequest-1")
		...
		XCTAssertEqual(inst.action?[0].action?[1].definition?.absoluteString, "#activitydefinition-medicationrequest-2")
	...
	func runPlanDefinition3(_ json: FHIRJSON? = nil) throws -> SwiftFHIRPlanDefinition {
		...
		XCTAssertEqual(inst.action?[0].definition?.absoluteString, "#procedure")
	...
	func runPlanDefinition4(_ json: FHIRJSON? = nil) throws -> SwiftFHIRPlanDefinition {
		...
		XCTAssertEqual(inst.action?[0].action?[0].action?[0].definition?.absoluteString, "#referralToMentalHealthCare")
		...
		XCTAssertEqual(inst.action?[0].action?[0].action?[0].dynamicValue?[2].expression, "SuicideRiskLogic.ServiceRequestFulfillmentTime")
		...
		XCTAssertEqual(inst.action?[0].action?[1].action?[0].action?[0].action?[0].definition?.absoluteString, "#citalopramPrescription")
	...
	func runPlanDefinition5(_ json: FHIRJSON? = nil) throws -> SwiftFHIRPlanDefinition {
		...
		XCTAssertEqual(inst.action?[0].action?[0].definition?.absoluteString, "ActivityDefinition/administer-zika-virus-exposure-assessment")
		...
		XCTAssertEqual(inst.action?[0].action?[1].definition?.absoluteString, "ActivityDefinition/order-serum-urine-rrt-pcr-test")
		...
		XCTAssertEqual(inst.action?[0].action?[2].definition?.absoluteString, "ActivityDefinition/order-serum-zika-dengue-virus-igm")
		...
		XCTAssertEqual(inst.action?[0].action?[3].definition?.absoluteString, "ActivityDefinition/consider-igm-antibody-testing")
		XCTAssertEqual(inst.action?[0].action?[4].action?[0].definition?.absoluteString, "ActivityDefinition/provide-mosquito-prevention-advice")
		XCTAssertEqual(inst.action?[0].action?[4].action?[1].definition?.absoluteString, "ActivityDefinition/provide-contraception-advice")
