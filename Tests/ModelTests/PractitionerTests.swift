...
class PractitionerTests: XCTestCase {
	...
	func runPractitioner1(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.Practitioner {
		...
		XCTAssertEqual(inst.role?[0].code?.coding?[0].code, "01.000")
		XCTAssertEqual(inst.role?[0].code?.coding?[0].display, "Arts")
		XCTAssertEqual(inst.role?[0].code?.coding?[0].system?.absoluteString, "urn:oid:2.16.840.1.113883.2.4.15.111")
		XCTAssertEqual(inst.role?[0].code?.text, "Care role")
		XCTAssertEqual(inst.role?[0].organization?.display, "BMC")
		XCTAssertEqual(inst.role?[0].organization?.reference, "Organization/f001")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].code, "01.018")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].display, "Ear-, Nose and Throat")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].system?.absoluteString, "urn:oid:2.16.840.1.113883.2.4.15.111")
		XCTAssertEqual(inst.role?[0].specialty?[0].text, "specialization")
	...
	func runPractitioner2(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.Practitioner {
		...
		XCTAssertEqual(inst.role?[0].organization?.display, "BMC")
		XCTAssertEqual(inst.role?[0].organization?.reference, "Organization/f001")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].code, "01.011")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].display, "Cardiothoracal surgery")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].system?.absoluteString, "urn:oid:2.16.840.1.113883.2.4.15.111")
		XCTAssertEqual(inst.role?[0].specialty?[0].text, "specialization")
		XCTAssertEqual(inst.telecom?[0].system, ContactPointSystem(rawValue: "phone")!)
		XCTAssertEqual(inst.telecom?[0].use, ContactPointUse(rawValue: "work")!)
	...
	func runPractitioner5(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.Practitioner {
		...
		XCTAssertEqual(inst.role?[0].organization?.reference, "Organization/f001")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].code, "01.018")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].display, "Keel- neus- en oorarts")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].system?.absoluteString, "urn:oid:2.16.840.1.113883.2.4.15.111")
		XCTAssertEqual(inst.role?[0].specialty?[0].text, "specialization")
		XCTAssertEqual(inst.telecom?[0].system, ContactPointSystem(rawValue: "phone")!)
		XCTAssertEqual(inst.telecom?[0].use, ContactPointUse(rawValue: "work")!)
	...
	func runPractitioner6(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.Practitioner {
		...
		XCTAssertEqual(inst.role?[0].organization?.display, "BMC")
		XCTAssertEqual(inst.role?[0].organization?.reference, "Organization/f001")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].code, "17.000")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].display, "Pharmacist")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].system?.absoluteString, "urn:oid:2.16.840.1.113883.2.4.15.111")
		XCTAssertEqual(inst.role?[0].specialty?[0].text, "specialization")
		XCTAssertEqual(inst.telecom?[0].system, ContactPointSystem(rawValue: "phone")!)
		XCTAssertEqual(inst.telecom?[0].use, ContactPointUse(rawValue: "work")!)
	...
	func runPractitioner7(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.Practitioner {
		...
		XCTAssertEqual(inst.role?[0].organization?.display, "BMC")
		XCTAssertEqual(inst.role?[0].organization?.reference, "Organization/f001")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].code, "01.015")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].display, "Physician")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].system?.absoluteString, "urn:oid:2.16.840.1.113883.2.4.15.111")
		XCTAssertEqual(inst.role?[0].specialty?[0].text, "specialization")
		XCTAssertEqual(inst.telecom?[0].system, ContactPointSystem(rawValue: "phone")!)
		XCTAssertEqual(inst.telecom?[0].use, ContactPointUse(rawValue: "work")!)
	...
	func runPractitioner8(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.Practitioner {
		...
		XCTAssertEqual(inst.role?[0].code?.coding?[0].code, "225304007")
		XCTAssertEqual(inst.role?[0].code?.coding?[0].display, "Implementation of planned interventions")
		XCTAssertEqual(inst.role?[0].code?.coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.role?[0].organization?.display, "AUMC")
		XCTAssertEqual(inst.role?[0].organization?.reference, "Organization/f201")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].code, "310512001")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].display, "Medical oncologist")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.telecom?[0].system, ContactPointSystem(rawValue: "phone")!)
		XCTAssertEqual(inst.telecom?[0].use, ContactPointUse(rawValue: "work")!)
	...
	func runPractitioner9(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.Practitioner {
		...
		XCTAssertEqual(inst.name?[0].use, NameUse(rawValue: "official")!)
		XCTAssertEqual(inst.role?[0].code?.coding?[0].code, "33526004")
		XCTAssertEqual(inst.role?[0].code?.coding?[0].display, "Electronic laboratory reporting")
		XCTAssertEqual(inst.role?[0].code?.coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.role?[0].organization?.display, "AUMC")
		XCTAssertEqual(inst.role?[0].organization?.reference, "Organization/f201")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].code, "159285000")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].display, "Medical laboratory technician")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.telecom?[0].system, ContactPointSystem(rawValue: "phone")!)
		XCTAssertEqual(inst.telecom?[0].use, ContactPointUse(rawValue: "work")!)
		XCTAssertEqual(inst.telecom?[0].value, "+31715269111")
	...
	func runPractitioner10(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.Practitioner {
		...
		XCTAssertEqual(inst.name?[0].use, NameUse(rawValue: "official")!)
		XCTAssertEqual(inst.role?[0].code?.coding?[0].code, "36682004")
		XCTAssertEqual(inst.role?[0].code?.coding?[0].display, "Physical therapist")
		XCTAssertEqual(inst.role?[0].code?.coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.role?[0].organization?.display, "AUMC")
		XCTAssertEqual(inst.role?[0].organization?.reference, "Organization/f201")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].code, "410158009")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].display, "Assess physical therapist service")
		XCTAssertEqual(inst.role?[0].specialty?[0].coding?[0].system?.absoluteString, "http://snomed.info/sct")
		XCTAssertEqual(inst.telecom?[0].system, ContactPointSystem(rawValue: "phone")!)
		XCTAssertEqual(inst.telecom?[0].use, ContactPointUse(rawValue: "work")!)
		XCTAssertEqual(inst.telecom?[0].value, "+31715269111")
