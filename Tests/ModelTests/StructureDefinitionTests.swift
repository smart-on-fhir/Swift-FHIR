...
class StructureDefinitionTests: XCTestCase {
	...
	func runStructureDefinition1(_ json: FHIRJSON? = nil) throws -> SwiftFHIRStructureDefinition {
		...
		XCTAssertEqual(inst.differential?.element?[0].id, "Extension:anadditionalexamplevalue")
		...
		XCTAssertEqual(inst.differential?.element?[1].id, "Extension:anadditionalexamplevalue.extension:index")
		...
		XCTAssertEqual(inst.differential?.element?[1].sliceName, "index")
		XCTAssertEqual(inst.differential?.element?[1].type?[0].code?.absoluteString, "Extension")
		XCTAssertEqual(inst.differential?.element?[2].fixedUri?.absoluteString, "index")
		XCTAssertEqual(inst.differential?.element?[2].id, "Extension:anadditionalexamplevalue.extension:index.url")
		XCTAssertEqual(inst.differential?.element?[2].path, "Extension.extension.url")
		XCTAssertEqual(inst.differential?.element?[2].type?[0].code?.absoluteString, "uri")
		XCTAssertEqual(inst.differential?.element?[3].id, "Extension:anadditionalexamplevalue.extension:index.valueString")
		XCTAssertEqual(inst.differential?.element?[3].path, "Extension.extension.valueString")
		XCTAssertEqual(inst.differential?.element?[3].type?[0].code?.absoluteString, "string")
		XCTAssertEqual(inst.differential?.element?[4].definition, "Value of the example.")
		XCTAssertEqual(inst.differential?.element?[4].id, "Extension:anadditionalexamplevalue.extension:exvalue")
		XCTAssertEqual(inst.differential?.element?[4].max, "1")
		XCTAssertEqual(inst.differential?.element?[4].min, 0)
		XCTAssertEqual(inst.differential?.element?[4].path, "Extension.extension")
		XCTAssertEqual(inst.differential?.element?[4].short, "Value of the example")
		XCTAssertEqual(inst.differential?.element?[4].sliceName, "exValue")
		XCTAssertEqual(inst.differential?.element?[4].type?[0].code?.absoluteString, "Extension")
		XCTAssertEqual(inst.differential?.element?[5].id, "Extension:anadditionalexamplevalue.extension:exvalue.extension:extension")
		XCTAssertEqual(inst.differential?.element?[5].max, "0")
		XCTAssertEqual(inst.differential?.element?[5].path, "Extension.extension.extension")
		XCTAssertEqual(inst.differential?.element?[5].sliceName, "extension")
		XCTAssertEqual(inst.differential?.element?[6].fixedUri?.absoluteString, "exValue")
		XCTAssertEqual(inst.differential?.element?[6].id, "Extension:anadditionalexamplevalue.extension:exvalue.url")
		XCTAssertEqual(inst.differential?.element?[6].path, "Extension.extension.url")
		XCTAssertEqual(inst.differential?.element?[6].type?[0].code?.absoluteString, "uri")
		XCTAssertEqual(inst.differential?.element?[7].id, "Extension:anadditionalexamplevalue.extension:exvalue.value[x]")
		XCTAssertEqual(inst.differential?.element?[7].min, 1)
		XCTAssertEqual(inst.differential?.element?[7].path, "Extension.extension.value[x]")
		XCTAssertEqual(inst.differential?.element?[7].type?[0].code?.absoluteString, "base64Binary")
		XCTAssertEqual(inst.differential?.element?[7].type?[1].code?.absoluteString, "boolean")
		XCTAssertEqual(inst.differential?.element?[7].type?[2].code?.absoluteString, "code")
		XCTAssertEqual(inst.differential?.element?[7].type?[3].code?.absoluteString, "date")
		XCTAssertEqual(inst.differential?.element?[7].type?[4].code?.absoluteString, "dateTime")
		XCTAssertEqual(inst.differential?.element?[7].type?[5].code?.absoluteString, "decimal")
		XCTAssertEqual(inst.differential?.element?[7].type?[6].code?.absoluteString, "id")
		XCTAssertEqual(inst.differential?.element?[7].type?[7].code?.absoluteString, "instant")
		XCTAssertEqual(inst.differential?.element?[7].type?[8].code?.absoluteString, "integer")
		XCTAssertEqual(inst.differential?.element?[7].type?[9].code?.absoluteString, "markdown")
		XCTAssertEqual(inst.differential?.element?[8].fixedUri?.absoluteString, "http://hl7.org/fhir/StructureDefinition/structuredefinition-example")
		XCTAssertEqual(inst.differential?.element?[8].id, "Extension:anadditionalexamplevalue.url")
		XCTAssertEqual(inst.differential?.element?[8].path, "Extension.url")
		XCTAssertEqual(inst.differential?.element?[8].type?[0].code?.absoluteString, "uri")
		XCTAssertEqual(inst.differential?.element?[9].id, "Extension:anadditionalexamplevalue.valueString")
		XCTAssertEqual(inst.differential?.element?[9].path, "Extension.valueString")
		XCTAssertEqual(inst.differential?.element?[9].type?[0].code?.absoluteString, "string")
		...
		XCTAssertEqual(inst.mapping?[0].name, "RIM Mapping")
		XCTAssertEqual(inst.mapping?[0].uri?.absoluteString, "http://hl7.org/v3")
		...
		XCTAssertEqual(inst.snapshot?.element?[0].condition?[0], "ele-1")
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[0].expression, "children().count() > id.count()")
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[0].human, "All FHIR elements must have a @value or children")
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[0].key, "ele-1")
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[0].severity, ConstraintSeverity(rawValue: "error")!)
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[0].source?.absoluteString, "Element")
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[0].xpath, "@value|f:*|h:div")
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[1].expression, "extension.exists() != value.exists()")
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[1].human, "Must have either extensions or value[x], not both")
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[1].key, "ext-1")
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[1].severity, ConstraintSeverity(rawValue: "error")!)
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[1].source?.absoluteString, "Extension")
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[1].xpath, "exists(f:extension)!=exists(f:*[starts-with(local-name(.), 'value')])")
		XCTAssertEqual(inst.snapshot?.element?[0].definition, "An additional example value.")
		XCTAssertEqual(inst.snapshot?.element?[0].id, "Extension:anadditionalexamplevalue")
		...
		XCTAssertEqual(inst.snapshot?.element?[1].base?.max, "1")
		XCTAssertEqual(inst.snapshot?.element?[1].base?.min, 0)
		XCTAssertEqual(inst.snapshot?.element?[1].base?.path, "Element.id")
		XCTAssertEqual(inst.snapshot?.element?[1].definition, "unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.")
		XCTAssertEqual(inst.snapshot?.element?[1].id, "Extension:anadditionalexamplevalue.id")
		...
		XCTAssertEqual(inst.snapshot?.element?[1].representation?[0], PropertyRepresentation(rawValue: "xmlAttr")!)
		XCTAssertEqual(inst.snapshot?.element?[1].short, "xml:id (or equivalent in JSON)")
		XCTAssertEqual(inst.snapshot?.element?[1].type?[0].code?.absoluteString, "string")
		...
		XCTAssertEqual(inst.snapshot?.element?[2].id, "Extension:anadditionalexamplevalue.extension")
		...
		XCTAssertEqual(inst.snapshot?.element?[2].slicing?.id, "79")
		...
		XCTAssertEqual(inst.snapshot?.element?[3].id, "Extension:anadditionalexamplevalue.extension:index")
		...
		XCTAssertEqual(inst.snapshot?.element?[3].sliceName, "index")
		XCTAssertEqual(inst.snapshot?.element?[3].type?[0].code?.absoluteString, "Extension")
		...
		XCTAssertEqual(inst.snapshot?.element?[4].definition, "unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.")
		XCTAssertEqual(inst.snapshot?.element?[4].id, "Extension:anadditionalexamplevalue.extension:index.id")
		...
		XCTAssertEqual(inst.snapshot?.element?[4].representation?[0], PropertyRepresentation(rawValue: "xmlAttr")!)
		XCTAssertEqual(inst.snapshot?.element?[4].short, "xml:id (or equivalent in JSON)")
		XCTAssertEqual(inst.snapshot?.element?[4].type?[0].code?.absoluteString, "string")
		XCTAssertEqual(inst.snapshot?.element?[5].alias?[0], "extensions")
		XCTAssertEqual(inst.snapshot?.element?[5].alias?[1], "user content")
		...
		XCTAssertEqual(inst.snapshot?.element?[5].id, "Extension:anadditionalexamplevalue.extension:index.extension")
		XCTAssertEqual(inst.snapshot?.element?[5].mapping?[0].identity, "rim")
		XCTAssertEqual(inst.snapshot?.element?[5].mapping?[0].map, "n/a")
		XCTAssertEqual(inst.snapshot?.element?[5].max, "*")
		XCTAssertEqual(inst.snapshot?.element?[5].min, 0)
		XCTAssertEqual(inst.snapshot?.element?[5].path, "Extension.extension.extension")
		XCTAssertEqual(inst.snapshot?.element?[5].short, "Additional Content defined by implementations")
		XCTAssertEqual(inst.snapshot?.element?[5].type?[0].code?.absoluteString, "Extension")
		...
		XCTAssertEqual(inst.snapshot?.element?[6].id, "Extension:anadditionalexamplevalue.extension:index.url")
		...
		XCTAssertEqual(inst.snapshot?.element?[6].representation?[0], PropertyRepresentation(rawValue: "xmlAttr")!)
		XCTAssertEqual(inst.snapshot?.element?[6].short, "identifies the meaning of the extension")
		XCTAssertEqual(inst.snapshot?.element?[6].type?[0].code?.absoluteString, "uri")
		...
		XCTAssertEqual(inst.snapshot?.element?[7].id, "Extension:anadditionalexamplevalue.extension:index.valueString")
		...
		XCTAssertEqual(inst.snapshot?.element?[7].min, 0)
		...
		XCTAssertEqual(inst.snapshot?.element?[7].type?[0].code?.absoluteString, "string")
		...
		XCTAssertEqual(inst.snapshot?.element?[8].id, "Extension:anadditionalexamplevalue.extension:exvalue")
		...
		XCTAssertEqual(inst.snapshot?.element?[8].sliceName, "exValue")
		XCTAssertEqual(inst.snapshot?.element?[8].type?[0].code?.absoluteString, "Extension")
		XCTAssertEqual(inst.snapshot?.element?[9].base?.max, "1")
		XCTAssertEqual(inst.snapshot?.element?[9].base?.min, 0)
		XCTAssertEqual(inst.snapshot?.element?[9].base?.path, "Element.id")
		XCTAssertEqual(inst.snapshot?.element?[9].definition, "unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.")
		XCTAssertEqual(inst.snapshot?.element?[9].id, "Extension:anadditionalexamplevalue.extension:exvalue.id")
		...
		XCTAssertEqual(inst.snapshot?.element?[9].representation?[0], PropertyRepresentation(rawValue: "xmlAttr")!)
		XCTAssertEqual(inst.snapshot?.element?[9].short, "xml:id (or equivalent in JSON)")
		XCTAssertEqual(inst.snapshot?.element?[9].type?[0].code?.absoluteString, "string")
		XCTAssertEqual(inst.status, PublicationStatus(rawValue: "draft")!)
		XCTAssertEqual(inst.title, "example")
		XCTAssertEqual(inst.type, "Extension")
