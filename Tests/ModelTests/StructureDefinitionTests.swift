...
class StructureDefinitionTests: XCTestCase {
	...
	func runStructureDefinition1(json: FHIRJSON? = nil) throws -> StructureDefinition {
		...
		XCTAssertEqual(inst.differential!.element![8].type![0].code, "base64Binary")
		XCTAssertEqual(inst.differential!.element![8].type![1].code, "boolean")
		XCTAssertEqual(inst.differential!.element![8].type![2].code, "code")
		XCTAssertEqual(inst.differential!.element![8].type![3].code, "date")
		XCTAssertEqual(inst.differential!.element![8].type![4].code, "dateTime")
		XCTAssertEqual(inst.differential!.element![8].type![5].code, "decimal")
		XCTAssertEqual(inst.differential!.element![8].type![6].code, "id")
		XCTAssertEqual(inst.differential!.element![8].type![7].code, "instant")
		XCTAssertEqual(inst.differential!.element![8].type![8].code, "integer")
		XCTAssertEqual(inst.differential!.element![8].type![9].code, "markdown")
		...
		XCTAssertEqual(inst.fhirVersion, "1.6.0")
		...
		XCTAssertEqual(inst.snapshot!.element![1].type![0].code, "string")
		...
		XCTAssertEqual(inst.snapshot!.element![2].slicing!.id, "77")
		...
		XCTAssertEqual(inst.snapshot!.element![4].type![0].code, "string")
		...
		XCTAssertEqual(inst.snapshot!.element![9].type![0].code, "string")
	...
	func runStructureDefinition2(json: FHIRJSON? = nil) throws -> StructureDefinition {
		...
		XCTAssertEqual(inst.snapshot!.element![6].type![0].profile?.absoluteString, "http://hl7.org/fhir/StructureDefinition/Patient")
		XCTAssertEqual(inst.snapshot!.element![6].type![1].code, "Reference")
		XCTAssertEqual(inst.snapshot!.element![6].type![1].profile?.absoluteString, "http://hl7.org/fhir/StructureDefinition/Group")
		XCTAssertEqual(inst.snapshot!.element![6].type![2].code, "Reference")
		XCTAssertEqual(inst.snapshot!.element![6].type![2].profile?.absoluteString, "http://hl7.org/fhir/StructureDefinition/Device")
		XCTAssertEqual(inst.snapshot!.element![7].base!.max, "1")
		...
		XCTAssertEqual(inst.snapshot!.element![7].type![0].profile?.absoluteString, "http://hl7.org/fhir/StructureDefinition/Observation")
		XCTAssertEqual(inst.snapshot!.element![8].base!.max, "*")
		XCTAssertEqual(inst.snapshot!.element![8].base!.min, 0)
		...
		XCTAssertEqual(inst.snapshot!.element![9].type![0].profile?.absoluteString, "http://hl7.org/fhir/StructureDefinition/DiagnosticRequest")
		XCTAssertEqual(inst.status, "draft")
