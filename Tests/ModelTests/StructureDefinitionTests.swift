...
class StructureDefinitionTests: XCTestCase {
	...
	func runStructureDefinition1(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.StructureDefinition {
		...
		XCTAssertEqual(inst.differential?.element?[2].id, "Extension:anadditionalexamplevalue.extension:index.extension:extension")
		...
		XCTAssertEqual(inst.differential?.element?[2].sliceName, "extension")
		XCTAssertEqual(inst.differential?.element?[3].fixedUri?.absoluteString, "index")
		XCTAssertEqual(inst.differential?.element?[3].id, "Extension:anadditionalexamplevalue.extension:index.url")
		XCTAssertEqual(inst.differential?.element?[3].path, "Extension.extension.url")
		XCTAssertEqual(inst.differential?.element?[3].type?[0].code?.absoluteString, "uri")
		XCTAssertEqual(inst.differential?.element?[4].id, "Extension:anadditionalexamplevalue.extension:index.value[x]")
		...
		XCTAssertEqual(inst.differential?.element?[4].type?[0].code?.absoluteString, "string")
		XCTAssertEqual(inst.differential?.element?[5].definition, "Value of the example.")
		XCTAssertEqual(inst.differential?.element?[5].id, "Extension:anadditionalexamplevalue.extension:exvalue")
		...
		XCTAssertEqual(inst.differential?.element?[5].sliceName, "exValue")
		XCTAssertEqual(inst.differential?.element?[5].type?[0].code?.absoluteString, "Extension")
		XCTAssertEqual(inst.differential?.element?[6].id, "Extension:anadditionalexamplevalue.extension:exvalue.extension:extension")
		...
		XCTAssertEqual(inst.differential?.element?[6].sliceName, "extension")
		XCTAssertEqual(inst.differential?.element?[7].fixedUri?.absoluteString, "exValue")
		XCTAssertEqual(inst.differential?.element?[7].id, "Extension:anadditionalexamplevalue.extension:exvalue.url")
		XCTAssertEqual(inst.differential?.element?[7].path, "Extension.extension.url")
		XCTAssertEqual(inst.differential?.element?[7].type?[0].code?.absoluteString, "uri")
		XCTAssertEqual(inst.differential?.element?[8].id, "Extension:anadditionalexamplevalue.extension:exvalue.value[x]")
		...
		XCTAssertEqual(inst.differential?.element?[8].type?[0].code?.absoluteString, "base64Binary")
		XCTAssertEqual(inst.differential?.element?[8].type?[1].code?.absoluteString, "boolean")
		XCTAssertEqual(inst.differential?.element?[8].type?[2].code?.absoluteString, "code")
		XCTAssertEqual(inst.differential?.element?[8].type?[3].code?.absoluteString, "date")
		XCTAssertEqual(inst.differential?.element?[8].type?[4].code?.absoluteString, "dateTime")
		XCTAssertEqual(inst.differential?.element?[8].type?[5].code?.absoluteString, "decimal")
		XCTAssertEqual(inst.differential?.element?[8].type?[6].code?.absoluteString, "id")
		XCTAssertEqual(inst.differential?.element?[8].type?[7].code?.absoluteString, "instant")
		XCTAssertEqual(inst.differential?.element?[8].type?[8].code?.absoluteString, "integer")
		XCTAssertEqual(inst.differential?.element?[8].type?[9].code?.absoluteString, "markdown")
		...
		XCTAssertEqual(inst.snapshot?.element?[5].id, "Extension:anadditionalexamplevalue.extension:index.extension:extension")
		...
		XCTAssertEqual(inst.snapshot?.element?[5].sliceName, "extension")
