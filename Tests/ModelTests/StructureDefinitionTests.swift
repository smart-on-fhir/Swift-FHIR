...
class StructureDefinitionTests: XCTestCase {
	...
	func runStructureDefinition1(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.StructureDefinition {
		...
		XCTAssertEqual(inst.kind, "complex-type")
		...
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[0].severity, "error")
		...
		XCTAssertEqual(inst.snapshot?.element?[0].constraint?[1].severity, "error")
